...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__29821,k,f){
var vec__29823 = p__29821;
...
var G__29864 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__29864;
continue;
}
break;
...
var G__29868 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__29868;
continue;
} else {
return zloc__$1;
...
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29839__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__29836;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__29844){
var vec__29846 = p__29844;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29846,(0),null);
var map__29849 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29846,(1),null);
var map__29849__$1 = (((((!((map__29849 == null))))?(((((map__29849.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29849.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29849):map__29849);
var path = map__29849__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29849__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__29846;
if(cljs.core.seq(r)){
