...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__60142_SHARP_){
return handle_mode(p1__60142_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(modes,p1__60142_SHARP_));
}),cljs.core.keys(modes));
} else {
if(cljs.core.vector_QMARK_(modes)){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__60144_SHARP_){
return handle_mode(cljs.core.first(p1__60144_SHARP_),cljs.core.second(p1__60144_SHARP_));
}),modes);
} else {
return null;
}
 ...
 */
stylefy.impl.conversion.convert_supports_rules = (function stylefy$impl$conversion$convert_supports_rules(p__60160,options){
