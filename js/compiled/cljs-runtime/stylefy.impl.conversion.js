 ...
 */
stylefy.impl.conversion.convert_base_style_into_class = (function stylefy$impl$conversion$convert_base_style_into_class(p__60148,options){
...
var manual_selector_and_css_props = clojure.walk.walk((function (p1__60159_SHARP_){
if(cljs.core.map_QMARK_(p1__60159_SHARP_)){
return stylefy.impl.utils.remove_special_keywords(p1__60159_SHARP_);
} else {
return p1__60159_SHARP_;
}
