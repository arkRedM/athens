...
var selected_items = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.first,athens.db.uid_and_embed_id),cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("selected","items","selected/items",1686402211)], null))));
...
var map__66366 = athens.util.destruct_key_down(e);
...
var key_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66366__$1,new cljs.core.Keyword(null,"key-code","key-code",-1732114304));
var ctrl = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66366__$1,new cljs.core.Keyword(null,"ctrl","ctrl",361402094));
var meta = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66366__$1,new cljs.core.Keyword(null,"meta","meta",1499536964));
var shift = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66366__$1,new cljs.core.Keyword(null,"shift","shift",997140064));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66366__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
var editing_uid = cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("editing","uid","editing/uid",974963040)], null)));
if(cljs.core.truth_(athens.util.shortcut_key_QMARK_(meta,ctrl))){
var pred__66368 = cljs.core._EQ_;
var expr__66369 = key_code;
if(cljs.core.truth_((pred__66368.cljs$core$IFn$_invoke$arity$2 ? pred__66368.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.S,expr__66369) : pred__66368.call(null,goog.events.KeyCodes.S,expr__66369)))){
...
if(cljs.core.truth_((pred__66368.cljs$core$IFn$_invoke$arity$2 ? pred__66368.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.K,expr__66369) : pred__66368.call(null,goog.events.KeyCodes.K,expr__66369)))){
...
if(cljs.core.truth_((pred__66368.cljs$core$IFn$_invoke$arity$2 ? pred__66368.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.G,expr__66369) : pred__66368.call(null,goog.events.KeyCodes.G,expr__66369)))){
...
if(cljs.core.truth_((pred__66368.cljs$core$IFn$_invoke$arity$2 ? pred__66368.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.Z,expr__66369) : pred__66368.call(null,goog.events.KeyCodes.Z,expr__66369)))){
...
if(cljs.core.truth_((pred__66368.cljs$core$IFn$_invoke$arity$2 ? pred__66368.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.BACKSLASH,expr__66369) : pred__66368.call(null,goog.events.KeyCodes.BACKSLASH,expr__66369)))){
if(cljs.core.truth_(shift)){
...
if(cljs.core.truth_((pred__66368.cljs$core$IFn$_invoke$arity$2 ? pred__66368.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.H,expr__66369) : pred__66368.call(null,goog.events.KeyCodes.H,expr__66369)))){
...
var pred__66371 = cljs.core._EQ_;
var expr__66372 = key_code;
if(cljs.core.truth_((pred__66371.cljs$core$IFn$_invoke$arity$2 ? pred__66371.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.LEFT,expr__66372) : pred__66371.call(null,goog.events.KeyCodes.LEFT,expr__66372)))){
if((editing_uid == null)){
...
if(cljs.core.truth_((pred__66371.cljs$core$IFn$_invoke$arity$2 ? pred__66371.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.RIGHT,expr__66372) : pred__66371.call(null,goog.events.KeyCodes.RIGHT,expr__66372)))){
if((editing_uid == null)){
...
if(cljs.core.truth_((pred__66371.cljs$core$IFn$_invoke$arity$2 ? pred__66371.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.D,expr__66372) : pred__66371.call(null,goog.events.KeyCodes.D,expr__66372)))){
...
var map__66375 = node;
var map__66375__$1 = (((((!((map__66375 == null))))?(((((map__66375.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66375.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__66375):map__66375);
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66375__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66375__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
...
var walk_children = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66374_SHARP_){
var G__66377 = (depth + (1));
var G__66378 = p1__66374_SHARP_;
return (athens.listeners.walk_str.cljs$core$IFn$_invoke$arity$2 ? athens.listeners.walk_str.cljs$core$IFn$_invoke$arity$2(G__66377,G__66378) : athens.listeners.walk_str.call(null,G__66377,G__66378));
}),children));
...
var copy_data = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66380_SHARP_){
return athens.listeners.walk_str((0),p1__66380_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66379_SHARP_){
return athens.db.get_block_document(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),p1__66379_SHARP_], null));
}),uids)));
e.preventDefault();
...
var uids = cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("selected","items","selected/items",1686402211)], null)));
if(cljs.core.truth_(cljs.core.not_empty(uids))){
var copy_data = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66382_SHARP_){
return athens.listeners.walk_str((0),p1__66382_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66381_SHARP_){
return athens.db.get_block_document(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),p1__66381_SHARP_], null));
}),uids)));
e.preventDefault();
