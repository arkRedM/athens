...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__46478 = goog.object.get(JSJodaLocale,"Locale");
if((G__46478 == null)){
return null;
} else {
return goog.object.get(G__46478,"US");
}
}catch (e46477){if((e46477 instanceof Error)){
var e = e46477;
return null;
} else {
throw e46477;
