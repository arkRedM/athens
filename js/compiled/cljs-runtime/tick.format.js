...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__46482 = goog.object.get(JSJodaLocale,"Locale");
if((G__46482 == null)){
return null;
} else {
return goog.object.get(G__46482,"US");
}
