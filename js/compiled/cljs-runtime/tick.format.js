...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__46480 = goog.object.get(JSJodaLocale,"Locale");
if((G__46480 == null)){
return null;
} else {
return goog.object.get(G__46480,"US");
}
}catch (e46479){if((e46479 instanceof Error)){
var e = e46479;
return null;
} else {
throw e46479;
