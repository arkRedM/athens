...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__46483 = goog.object.get(JSJodaLocale,"Locale");
if((G__46483 == null)){
return null;
} else {
return goog.object.get(G__46483,"US");
}
}catch (e46482){if((e46482 instanceof Error)){
var e = e46482;
return null;
} else {
throw e46482;
