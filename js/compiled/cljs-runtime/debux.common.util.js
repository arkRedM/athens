...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54487_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__54487_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54486_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54486_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54494_SHARP_){
return (((p1__54494_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__54494_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__54514,mapping){
...
var state = map__54515__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54515__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54515__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54515__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54512_SHARP_){
if((p1__54512_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__54512_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__54615 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__54616 = clojure.zip.next(loc);
loc = G__54616;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__54549){
var vec__54550 = p__54549;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54550,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq54547){
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54553_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54553_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__54555_54624 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__54556_54625 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__54557_54626 = true;
var _STAR_print_fn_STAR__temp_val__54558_54627 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__54557_54626);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__54558_54627);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__54556_54625);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__54555_54624);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54554_SHARP_){
return debux.common.util.prepend_bars(p1__54554_SHARP_,indent_level);
...
if(cljs.core.truth_((function (){var fexpr__54575 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__54575.cljs$core$IFn$_invoke$arity$1 ? fexpr__54575.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54575.call(null,f));
})())){
...
if(cljs.core.truth_((function (){var fexpr__54576 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__54576.cljs$core$IFn$_invoke$arity$1 ? fexpr__54576.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54576.call(null,f));
})())){
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__54577){
var vec__54578 = p__54577;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54578,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54578,(1),null);
...
var G__54582 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__54581 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__54581.cljs$core$IFn$_invoke$arity$1 ? fexpr__54581.cljs$core$IFn$_invoke$arity$1(G__54582) : fexpr__54581.call(null,G__54582));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54584 = quoted_form;
var G__54585 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54584,G__54585) : debux.common.util.remove_d.call(null,G__54584,G__54585));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54588 = quoted_form;
var G__54589 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54588,G__54589) : debux.common.util.remove_d.call(null,G__54588,G__54589));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__54642__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54590 = quoted_form;
var G__54591 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54590,G__54591) : debux.common.util.remove_d.call(null,G__54590,G__54591));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
var G__54643__i = 0, G__54643__a = new Array(arguments.length -  0);
while (G__54643__i < G__54643__a.length) {G__54643__a[G__54643__i] = arguments[G__54643__i + 0]; ++G__54643__i;}
  arg = new cljs.core.IndexedSeq(G__54643__a,0,null);
} 
return G__54642__delegate.call(this,arg);};
G__54642.cljs$lang$maxFixedArity = 0;
G__54642.cljs$lang$applyTo = (function (arglist__54644){
var arg = cljs.core.seq(arglist__54644);
return G__54642__delegate(arg);
});
...
var G__54645 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__54645;
continue;
} else {
...
var G__54646 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__54646;
continue;
} else {
var G__54647 = clojure.zip.next(loc);
loc = G__54647;
continue;
