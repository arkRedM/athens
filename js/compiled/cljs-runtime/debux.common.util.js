...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57123_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__57123_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57122_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57122_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57124_SHARP_){
return (((p1__57124_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__57124_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57127,mapping){
...
var state = map__57128__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57128__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57128__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57128__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57125_SHARP_){
if((p1__57125_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57125_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57257 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57258 = clojure.zip.next(loc);
loc = G__57258;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57171){
var vec__57172 = p__57171;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57172,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57169){
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57175_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57175_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57177_57276 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57178_57277 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57179_57278 = true;
var _STAR_print_fn_STAR__temp_val__57180_57279 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57179_57278);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57180_57279);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57178_57277);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57177_57276);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57176_SHARP_){
return debux.common.util.prepend_bars(p1__57176_SHARP_,indent_level);
...
if(cljs.core.truth_((function (){var fexpr__57195 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57195.cljs$core$IFn$_invoke$arity$1 ? fexpr__57195.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57195.call(null,f));
})())){
...
if(cljs.core.truth_((function (){var fexpr__57196 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57196.cljs$core$IFn$_invoke$arity$1 ? fexpr__57196.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57196.call(null,f));
})())){
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57200){
var vec__57204 = p__57200;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57204,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57204,(1),null);
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57225 = quoted_form;
var G__57226 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57225,G__57226) : debux.common.util.remove_d.call(null,G__57225,G__57226));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57227 = quoted_form;
var G__57228 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57227,G__57228) : debux.common.util.remove_d.call(null,G__57227,G__57228));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__57299__i < G__57299__a.length) {G__57299__a[G__57299__i] = arguments[G__57299__i + 0]; ++G__57299__i;}
  arg = new cljs.core.IndexedSeq(G__57299__a,0,null);
} 
return G__57297__delegate.call(this,arg);};
G__57297.cljs$lang$maxFixedArity = 0;
G__57297.cljs$lang$applyTo = (function (arglist__57300){
var arg = cljs.core.seq(arglist__57300);
...
var G__57301 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57301;
continue;
} else {
...
var G__57302 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57302;
continue;
} else {
