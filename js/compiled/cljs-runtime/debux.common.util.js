...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50127_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50127_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50126_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50126_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50131_SHARP_){
return (((p1__50131_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50131_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50138,mapping){
...
var state = map__50139__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50139__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50139__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50139__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50136_SHARP_){
if((p1__50136_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50136_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__50214 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__50215 = clojure.zip.next(loc);
loc = G__50215;
continue;
}
}
...
var len__4736__auto___50218 = arguments.length;
var i__4737__auto___50219 = (0);
while(true){
if((i__4737__auto___50219 < len__4736__auto___50218)){
args__4742__auto__.push((arguments[i__4737__auto___50219]));

var G__50220 = (i__4737__auto___50219 + (1));
i__4737__auto___50219 = G__50220;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__50160){
var vec__50161 = p__50160;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50161,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq50158){
var G__50159 = cljs.core.first(seq50158);
var seq50158__$1 = cljs.core.next(seq50158);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50159,seq50158__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50165_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50165_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__50168_50221 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50169_50222 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50170_50223 = true;
var _STAR_print_fn_STAR__temp_val__50171_50224 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50170_50223);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50171_50224);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50169_50222);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50168_50221);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50167_SHARP_){
return debux.common.util.prepend_bars(p1__50167_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__50225 = cljs.core.next(opts__$1);
var G__50226 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__50225;
acc = G__50226;
continue;
} else {
if(typeof f === 'string'){
var G__50227 = cljs.core.next(opts__$1);
var G__50228 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__50227;
acc = G__50228;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__50229 = cljs.core.nnext(opts__$1);
var G__50230 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__50229;
acc = G__50230;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__50231 = cljs.core.next(opts__$1);
var G__50232 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__50231;
acc = G__50232;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50174 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__50174.cljs$core$IFn$_invoke$arity$1 ? fexpr__50174.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50174.call(null,f));
})())){
var G__50233 = cljs.core.next(opts__$1);
var G__50234 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__50233;
acc = G__50234;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50175 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__50175.cljs$core$IFn$_invoke$arity$1 ? fexpr__50175.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50175.call(null,f));
})())){
var G__50235 = cljs.core.nnext(opts__$1);
var G__50236 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__50235;
acc = G__50236;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__50237 = cljs.core.next(opts__$1);
var G__50238 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__50237;
acc = G__50238;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__50176){
var vec__50179 = p__50176;
...
var G__50193 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__50192 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50203 = quoted_form;
var G__50204 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50203,G__50204) : debux.common.util.remove_d.call(null,G__50203,G__50204));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50207 = quoted_form;
var G__50208 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50207,G__50208) : debux.common.util.remove_d.call(null,G__50207,G__50208));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__50242__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50209 = quoted_form;
var G__50210 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50209,G__50210) : debux.common.util.remove_d.call(null,G__50209,G__50210));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__50245__i < G__50245__a.length) {G__50245__a[G__50245__i] = arguments[G__50245__i + 0]; ++G__50245__i;}
  arg = new cljs.core.IndexedSeq(G__50245__a,0,null);
} 
return G__50242__delegate.call(this,arg);};
G__50242.cljs$lang$maxFixedArity = 0;
G__50242.cljs$lang$applyTo = (function (arglist__50246){
var arg = cljs.core.seq(arglist__50246);
return G__50242__delegate(arg);
});
...
var G__50247 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__50247;
continue;
} else {
...
var G__50248 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__50248;
continue;
} else {
var G__50249 = clojure.zip.next(loc);
loc = G__50249;
continue;
