...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54524_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__54524_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54523_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54523_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54531_SHARP_){
return (((p1__54531_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__54531_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__54541,mapping){
...
var state = map__54542__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54542__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54542__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54542__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54539_SHARP_){
if((p1__54539_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__54539_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__54563){
var vec__54564 = p__54563;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54564,(0),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54567_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54567_SHARP_)].join('');
}),lines);
});
...
if(typeof f === 'number'){
var G__54631 = cljs.core.next(opts__$1);
var G__54632 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__54631;
acc = G__54632;
continue;
} else {
...
var G__54634 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__54633;
acc = G__54634;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__54635 = cljs.core.nnext(opts__$1);
var G__54636 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__54635;
acc = G__54636;
continue;
} else {
...
var G__54639 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__54638;
acc = G__54639;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54577 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__54577.cljs$core$IFn$_invoke$arity$1 ? fexpr__54577.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54577.call(null,f));
})())){
var G__54640 = cljs.core.next(opts__$1);
var G__54641 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__54640;
acc = G__54641;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54578 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__54578.cljs$core$IFn$_invoke$arity$1 ? fexpr__54578.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54578.call(null,f));
})())){
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__54579){
var vec__54580 = p__54579;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54580,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54580,(1),null);
...
var G__54588 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__54587 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__54587.cljs$core$IFn$_invoke$arity$1 ? fexpr__54587.cljs$core$IFn$_invoke$arity$1(G__54588) : fexpr__54587.call(null,G__54588));
});
