...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54424_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__54424_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54423_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54423_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54425_SHARP_){
return (((p1__54425_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__54425_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__54432,mapping){
...
var state = map__54433__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54433__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54433__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54433__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54430_SHARP_){
if((p1__54430_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__54430_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__54548 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__54549 = clojure.zip.next(loc);
loc = G__54549;
continue;
}
}
...
var len__4736__auto___54554 = arguments.length;
var i__4737__auto___54555 = (0);
while(true){
if((i__4737__auto___54555 < len__4736__auto___54554)){
args__4742__auto__.push((arguments[i__4737__auto___54555]));

var G__54556 = (i__4737__auto___54555 + (1));
i__4737__auto___54555 = G__54556;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__54453){
var vec__54454 = p__54453;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54454,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq54451){
var G__54452 = cljs.core.first(seq54451);
var seq54451__$1 = cljs.core.next(seq54451);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54452,seq54451__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54457_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54457_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__54459_54564 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__54460_54565 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__54461_54566 = true;
var _STAR_print_fn_STAR__temp_val__54462_54567 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__54461_54566);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__54462_54567);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__54460_54565);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__54459_54564);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54458_SHARP_){
return debux.common.util.prepend_bars(p1__54458_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__54586 = cljs.core.next(opts__$1);
var G__54587 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__54586;
acc = G__54587;
continue;
} else {
if(typeof f === 'string'){
var G__54588 = cljs.core.next(opts__$1);
var G__54589 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__54588;
acc = G__54589;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__54590 = cljs.core.nnext(opts__$1);
var G__54591 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__54590;
acc = G__54591;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__54592 = cljs.core.next(opts__$1);
var G__54593 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__54592;
acc = G__54593;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54478 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__54478.cljs$core$IFn$_invoke$arity$1 ? fexpr__54478.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54478.call(null,f));
})())){
var G__54594 = cljs.core.next(opts__$1);
var G__54595 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__54594;
acc = G__54595;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54479 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__54479.cljs$core$IFn$_invoke$arity$1 ? fexpr__54479.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54479.call(null,f));
})())){
var G__54596 = cljs.core.nnext(opts__$1);
var G__54597 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__54596;
acc = G__54597;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__54598 = cljs.core.next(opts__$1);
var G__54599 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__54598;
acc = G__54599;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__54487){
var vec__54488 = p__54487;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54488,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54488,(1),null);
...
var G__54506 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__54505 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54512 = quoted_form;
var G__54513 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54512,G__54513) : debux.common.util.remove_d.call(null,G__54512,G__54513));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54514 = quoted_form;
var G__54515 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54514,G__54515) : debux.common.util.remove_d.call(null,G__54514,G__54515));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__54602__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54516 = quoted_form;
var G__54517 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54516,G__54517) : debux.common.util.remove_d.call(null,G__54516,G__54517));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__54602 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__54603__i = 0, G__54603__a = new Array(arguments.length -  0);
while (G__54603__i < G__54603__a.length) {G__54603__a[G__54603__i] = arguments[G__54603__i + 0]; ++G__54603__i;}
  arg = new cljs.core.IndexedSeq(G__54603__a,0,null);
} 
return G__54602__delegate.call(this,arg);};
G__54602.cljs$lang$maxFixedArity = 0;
G__54602.cljs$lang$applyTo = (function (arglist__54604){
var arg = cljs.core.seq(arglist__54604);
return G__54602__delegate(arg);
});
G__54602.cljs$core$IFn$_invoke$arity$variadic = G__54602__delegate;
return G__54602;
})()
;
});
...
var G__54605 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__54605;
continue;
} else {
...
var G__54606 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__54606;
continue;
} else {
var G__54607 = clojure.zip.next(loc);
loc = G__54607;
continue;
