...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54423_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__54423_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54422_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54422_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54424_SHARP_){
return (((p1__54424_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__54424_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__54427,mapping){
...
var state = map__54428__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54428__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54428__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54428__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54425_SHARP_){
if((p1__54425_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__54425_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__54531 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__54532 = clojure.zip.next(loc);
loc = G__54532;
continue;
}
}
...
var G__54554 = (i__4737__auto___54553 + (1));
i__4737__auto___54553 = G__54554;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__54448){
var vec__54449 = p__54448;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54449,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq54442){
var G__54443 = cljs.core.first(seq54442);
var seq54442__$1 = cljs.core.next(seq54442);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54443,seq54442__$1);
}));
...
var _STAR_print_newline_STAR__orig_val__54459_54557 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__54460_54558 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__54461_54559 = true;
var _STAR_print_fn_STAR__temp_val__54462_54560 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__54461_54559);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__54462_54560);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__54460_54558);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__54459_54557);
}
...
if(typeof f === 'number'){
var G__54561 = cljs.core.next(opts__$1);
var G__54562 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__54561;
acc = G__54562;
continue;
} else {
if(typeof f === 'string'){
var G__54563 = cljs.core.next(opts__$1);
var G__54564 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__54563;
acc = G__54564;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__54565 = cljs.core.nnext(opts__$1);
var G__54566 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__54565;
acc = G__54566;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__54567 = cljs.core.next(opts__$1);
var G__54568 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__54567;
acc = G__54568;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54465 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__54465.cljs$core$IFn$_invoke$arity$1 ? fexpr__54465.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54465.call(null,f));
})())){
var G__54569 = cljs.core.next(opts__$1);
var G__54570 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__54569;
acc = G__54570;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54466 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__54466.cljs$core$IFn$_invoke$arity$1 ? fexpr__54466.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54466.call(null,f));
})())){
var G__54571 = cljs.core.nnext(opts__$1);
var G__54572 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__54571;
acc = G__54572;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__54573 = cljs.core.next(opts__$1);
var G__54574 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__54573;
acc = G__54574;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__54467){
var vec__54472 = p__54467;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54472,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54472,(1),null);
...
var G__54484 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__54483 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54494 = quoted_form;
var G__54495 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54494,G__54495) : debux.common.util.remove_d.call(null,G__54494,G__54495));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54510 = quoted_form;
var G__54511 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54510,G__54511) : debux.common.util.remove_d.call(null,G__54510,G__54511));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__54600__delegate = function (arg){
...
while (G__54601__i < G__54601__a.length) {G__54601__a[G__54601__i] = arguments[G__54601__i + 0]; ++G__54601__i;}
  arg = new cljs.core.IndexedSeq(G__54601__a,0,null);
} 
return G__54600__delegate.call(this,arg);};
G__54600.cljs$lang$maxFixedArity = 0;
G__54600.cljs$lang$applyTo = (function (arglist__54602){
var arg = cljs.core.seq(arglist__54602);
return G__54600__delegate(arg);
});
...
var G__54603 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__54603;
continue;
} else {
...
var G__54604 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__54604;
continue;
} else {
var G__54605 = clojure.zip.next(loc);
loc = G__54605;
continue;
