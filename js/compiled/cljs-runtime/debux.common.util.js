...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54518_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__54518_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54517_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54517_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54519_SHARP_){
return (((p1__54519_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__54519_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__54539,mapping){
...
var state = map__54540__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54540__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54540__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54540__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54537_SHARP_){
if((p1__54537_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__54537_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__54639 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__54641 = clojure.zip.next(loc);
loc = G__54641;
continue;
}
}
...
var len__4736__auto___54645 = arguments.length;
var i__4737__auto___54646 = (0);
while(true){
if((i__4737__auto___54646 < len__4736__auto___54645)){
args__4742__auto__.push((arguments[i__4737__auto___54646]));

var G__54648 = (i__4737__auto___54646 + (1));
i__4737__auto___54646 = G__54648;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__54574){
var vec__54575 = p__54574;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54575,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq54572){
var G__54573 = cljs.core.first(seq54572);
var seq54572__$1 = cljs.core.next(seq54572);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54573,seq54572__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54578_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54578_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__54580_54649 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__54581_54650 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__54582_54651 = true;
var _STAR_print_fn_STAR__temp_val__54583_54652 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__54582_54651);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__54583_54652);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__54581_54650);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__54580_54649);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54579_SHARP_){
return debux.common.util.prepend_bars(p1__54579_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__54653 = cljs.core.next(opts__$1);
var G__54654 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__54653;
acc = G__54654;
continue;
} else {
if(typeof f === 'string'){
var G__54655 = cljs.core.next(opts__$1);
var G__54656 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__54655;
acc = G__54656;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__54657 = cljs.core.nnext(opts__$1);
var G__54658 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__54657;
acc = G__54658;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__54659 = cljs.core.next(opts__$1);
var G__54660 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__54659;
acc = G__54660;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54600 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__54600.cljs$core$IFn$_invoke$arity$1 ? fexpr__54600.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54600.call(null,f));
})())){
var G__54661 = cljs.core.next(opts__$1);
var G__54662 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__54661;
acc = G__54662;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54601 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__54601.cljs$core$IFn$_invoke$arity$1 ? fexpr__54601.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54601.call(null,f));
})())){
var G__54663 = cljs.core.nnext(opts__$1);
var G__54664 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__54663;
acc = G__54664;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__54665 = cljs.core.next(opts__$1);
var G__54666 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__54665;
acc = G__54666;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__54602){
var vec__54603 = p__54602;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54603,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54603,(1),null);
...
var G__54607 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__54606 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54609 = quoted_form;
var G__54610 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54609,G__54610) : debux.common.util.remove_d.call(null,G__54609,G__54610));
...
return (function() { 
var G__54667__delegate = function (arg){
...
while (G__54668__i < G__54668__a.length) {G__54668__a[G__54668__i] = arguments[G__54668__i + 0]; ++G__54668__i;}
  arg = new cljs.core.IndexedSeq(G__54668__a,0,null);
} 
return G__54667__delegate.call(this,arg);};
G__54667.cljs$lang$maxFixedArity = 0;
G__54667.cljs$lang$applyTo = (function (arglist__54669){
var arg = cljs.core.seq(arglist__54669);
return G__54667__delegate(arg);
});
...
var G__54670 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__54670;
continue;
} else {
...
var G__54671 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__54671;
continue;
} else {
var G__54672 = clojure.zip.next(loc);
loc = G__54672;
continue;
