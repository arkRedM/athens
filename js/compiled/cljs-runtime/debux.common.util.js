...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54433_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__54433_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54432_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54432_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54434_SHARP_){
return (((p1__54434_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__54434_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__54439,mapping){
...
var state = map__54440__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54440__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54440__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54440__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54436_SHARP_){
if((p1__54436_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__54436_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__54580 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__54581 = clojure.zip.next(loc);
loc = G__54581;
continue;
}
}
...
var len__4736__auto___54586 = arguments.length;
var i__4737__auto___54587 = (0);
while(true){
if((i__4737__auto___54587 < len__4736__auto___54586)){
args__4742__auto__.push((arguments[i__4737__auto___54587]));
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__54485){
var vec__54490 = p__54485;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54490,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq54476){
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54500_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54500_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__54502_54589 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__54503_54590 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__54504_54591 = true;
var _STAR_print_fn_STAR__temp_val__54505_54592 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__54504_54591);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__54505_54592);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__54503_54590);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__54502_54589);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54501_SHARP_){
return debux.common.util.prepend_bars(p1__54501_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__54593 = cljs.core.next(opts__$1);
var G__54594 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__54593;
acc = G__54594;
continue;
} else {
if(typeof f === 'string'){
var G__54599 = cljs.core.next(opts__$1);
var G__54600 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__54599;
acc = G__54600;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__54605 = cljs.core.nnext(opts__$1);
var G__54606 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__54605;
acc = G__54606;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__54607 = cljs.core.next(opts__$1);
var G__54608 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__54607;
acc = G__54608;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54508 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__54508.cljs$core$IFn$_invoke$arity$1 ? fexpr__54508.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54508.call(null,f));
})())){
var G__54609 = cljs.core.next(opts__$1);
var G__54610 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__54609;
acc = G__54610;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54509 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__54509.cljs$core$IFn$_invoke$arity$1 ? fexpr__54509.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54509.call(null,f));
})())){
var G__54615 = cljs.core.nnext(opts__$1);
var G__54616 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__54615;
acc = G__54616;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__54617 = cljs.core.next(opts__$1);
var G__54618 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__54617;
acc = G__54618;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__54510){
var vec__54511 = p__54510;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54511,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54511,(1),null);
...
var G__54515 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__54514 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54526 = quoted_form;
var G__54527 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54526,G__54527) : debux.common.util.remove_d.call(null,G__54526,G__54527));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54531 = quoted_form;
var G__54532 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54531,G__54532) : debux.common.util.remove_d.call(null,G__54531,G__54532));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__54621__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54533 = quoted_form;
var G__54534 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54533,G__54534) : debux.common.util.remove_d.call(null,G__54533,G__54534));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__54622__i < G__54622__a.length) {G__54622__a[G__54622__i] = arguments[G__54622__i + 0]; ++G__54622__i;}
  arg = new cljs.core.IndexedSeq(G__54622__a,0,null);
} 
return G__54621__delegate.call(this,arg);};
G__54621.cljs$lang$maxFixedArity = 0;
G__54621.cljs$lang$applyTo = (function (arglist__54623){
var arg = cljs.core.seq(arglist__54623);
return G__54621__delegate(arg);
});
...
var G__54624 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__54624;
continue;
} else {
...
var G__54625 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__54625;
continue;
} else {
var G__54626 = clojure.zip.next(loc);
loc = G__54626;
continue;
