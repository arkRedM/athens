...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54553_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__54553_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54552_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54552_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54554_SHARP_){
return (((p1__54554_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__54554_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__54559,mapping){
...
var state = map__54560__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54560__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54560__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54560__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54557_SHARP_){
if((p1__54557_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__54557_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__54620 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__54622 = clojure.zip.next(loc);
loc = G__54622;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__54588){
var vec__54589 = p__54588;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54589,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq54585){
var G__54586 = cljs.core.first(seq54585);
var seq54585__$1 = cljs.core.next(seq54585);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54586,seq54585__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54593_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54593_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__54595_54629 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__54596_54630 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__54597_54631 = true;
var _STAR_print_fn_STAR__temp_val__54598_54632 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__54597_54631);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__54598_54632);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__54596_54630);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__54595_54629);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54594_SHARP_){
return debux.common.util.prepend_bars(p1__54594_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__54633 = cljs.core.next(opts__$1);
var G__54634 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__54633;
acc = G__54634;
continue;
} else {
if(typeof f === 'string'){
var G__54635 = cljs.core.next(opts__$1);
var G__54636 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__54635;
acc = G__54636;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__54637 = cljs.core.nnext(opts__$1);
var G__54638 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__54637;
acc = G__54638;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__54639 = cljs.core.next(opts__$1);
var G__54640 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__54639;
acc = G__54640;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54601 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__54601.cljs$core$IFn$_invoke$arity$1 ? fexpr__54601.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54601.call(null,f));
})())){
var G__54641 = cljs.core.next(opts__$1);
var G__54642 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__54641;
acc = G__54642;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54602 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__54602.cljs$core$IFn$_invoke$arity$1 ? fexpr__54602.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54602.call(null,f));
})())){
var G__54643 = cljs.core.nnext(opts__$1);
var G__54644 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__54643;
acc = G__54644;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__54645 = cljs.core.next(opts__$1);
var G__54646 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__54645;
acc = G__54646;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__54603){
var vec__54604 = p__54603;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54604,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54604,(1),null);
...
var G__54608 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__54607 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__54607.cljs$core$IFn$_invoke$arity$1 ? fexpr__54607.cljs$core$IFn$_invoke$arity$1(G__54608) : fexpr__54607.call(null,G__54608));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54614 = quoted_form;
var G__54615 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54614,G__54615) : debux.common.util.remove_d.call(null,G__54614,G__54615));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
