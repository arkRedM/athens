...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54544_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__54544_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54543_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54543_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54545_SHARP_){
return (((p1__54545_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__54545_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__54560,mapping){
...
var state = map__54561__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54561__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54561__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54561__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54558_SHARP_){
if((p1__54558_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__54558_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__54622 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__54623 = clojure.zip.next(loc);
loc = G__54623;
continue;
}
}
...
var len__4736__auto___54626 = arguments.length;
var i__4737__auto___54627 = (0);
while(true){
if((i__4737__auto___54627 < len__4736__auto___54626)){
args__4742__auto__.push((arguments[i__4737__auto___54627]));

var G__54628 = (i__4737__auto___54627 + (1));
i__4737__auto___54627 = G__54628;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__54570){
var vec__54571 = p__54570;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54571,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq54568){
var G__54569 = cljs.core.first(seq54568);
var seq54568__$1 = cljs.core.next(seq54568);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54569,seq54568__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54574_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54574_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__54580_54632 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__54581_54633 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__54582_54634 = true;
var _STAR_print_fn_STAR__temp_val__54583_54635 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__54582_54634);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__54583_54635);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__54581_54633);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__54580_54632);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54578_SHARP_){
return debux.common.util.prepend_bars(p1__54578_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__54638 = cljs.core.next(opts__$1);
var G__54639 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__54638;
acc = G__54639;
continue;
} else {
...
var G__54641 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__54640;
acc = G__54641;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__54642 = cljs.core.nnext(opts__$1);
var G__54643 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__54642;
acc = G__54643;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__54644 = cljs.core.next(opts__$1);
var G__54645 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__54644;
acc = G__54645;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54604 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__54604.cljs$core$IFn$_invoke$arity$1 ? fexpr__54604.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54604.call(null,f));
})())){
var G__54646 = cljs.core.next(opts__$1);
var G__54647 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__54646;
acc = G__54647;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54605 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__54605.cljs$core$IFn$_invoke$arity$1 ? fexpr__54605.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54605.call(null,f));
})())){
var G__54648 = cljs.core.nnext(opts__$1);
var G__54649 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__54648;
acc = G__54649;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__54650 = cljs.core.next(opts__$1);
var G__54651 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__54650;
acc = G__54651;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__54606){
var vec__54607 = p__54606;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54607,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54607,(1),null);
...
var G__54611 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__54610 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__54610.cljs$core$IFn$_invoke$arity$1 ? fexpr__54610.cljs$core$IFn$_invoke$arity$1(G__54611) : fexpr__54610.call(null,G__54611));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54615 = quoted_form;
var G__54616 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54615,G__54616) : debux.common.util.remove_d.call(null,G__54615,G__54616));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54617 = quoted_form;
var G__54618 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54617,G__54618) : debux.common.util.remove_d.call(null,G__54617,G__54618));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__54652__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54619 = quoted_form;
var G__54620 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54619,G__54620) : debux.common.util.remove_d.call(null,G__54619,G__54620));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__54653__i < G__54653__a.length) {G__54653__a[G__54653__i] = arguments[G__54653__i + 0]; ++G__54653__i;}
  arg = new cljs.core.IndexedSeq(G__54653__a,0,null);
} 
return G__54652__delegate.call(this,arg);};
G__54652.cljs$lang$maxFixedArity = 0;
G__54652.cljs$lang$applyTo = (function (arglist__54654){
var arg = cljs.core.seq(arglist__54654);
return G__54652__delegate(arg);
});
...
var G__54655 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__54655;
continue;
} else {
...
var G__54656 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__54656;
continue;
} else {
var G__54657 = clojure.zip.next(loc);
loc = G__54657;
continue;
