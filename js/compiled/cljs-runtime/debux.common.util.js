...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54617_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__54617_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54616_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54616_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54618_SHARP_){
return (((p1__54618_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__54618_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__54621,mapping){
...
var state = map__54622__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54622__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54622__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54622__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54619_SHARP_){
if((p1__54619_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__54619_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__54655 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__54656 = clojure.zip.next(loc);
loc = G__54656;
continue;
}
}
...
var len__4736__auto___54659 = arguments.length;
var i__4737__auto___54660 = (0);
while(true){
if((i__4737__auto___54660 < len__4736__auto___54659)){
args__4742__auto__.push((arguments[i__4737__auto___54660]));

var G__54661 = (i__4737__auto___54660 + (1));
i__4737__auto___54660 = G__54661;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__54627){
var vec__54628 = p__54627;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54628,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq54625){
var G__54626 = cljs.core.first(seq54625);
var seq54625__$1 = cljs.core.next(seq54625);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54626,seq54625__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54631_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54631_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__54633_54662 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__54634_54663 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__54635_54664 = true;
var _STAR_print_fn_STAR__temp_val__54636_54665 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__54635_54664);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__54636_54665);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__54634_54663);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__54633_54662);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54632_SHARP_){
return debux.common.util.prepend_bars(p1__54632_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__54666 = cljs.core.next(opts__$1);
var G__54667 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__54666;
acc = G__54667;
continue;
} else {
if(typeof f === 'string'){
var G__54668 = cljs.core.next(opts__$1);
var G__54669 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__54668;
acc = G__54669;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__54670 = cljs.core.nnext(opts__$1);
var G__54671 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__54670;
acc = G__54671;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__54672 = cljs.core.next(opts__$1);
var G__54673 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__54672;
acc = G__54673;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54639 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__54639.cljs$core$IFn$_invoke$arity$1 ? fexpr__54639.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54639.call(null,f));
})())){
var G__54674 = cljs.core.next(opts__$1);
var G__54675 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__54674;
acc = G__54675;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54640 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__54640.cljs$core$IFn$_invoke$arity$1 ? fexpr__54640.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54640.call(null,f));
})())){
var G__54676 = cljs.core.nnext(opts__$1);
var G__54677 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__54676;
acc = G__54677;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__54678 = cljs.core.next(opts__$1);
var G__54679 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__54678;
acc = G__54679;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__54641){
var vec__54642 = p__54641;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54642,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54642,(1),null);
...
var G__54646 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__54645 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__54645.cljs$core$IFn$_invoke$arity$1 ? fexpr__54645.cljs$core$IFn$_invoke$arity$1(G__54646) : fexpr__54645.call(null,G__54646));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54648 = quoted_form;
var G__54649 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54648,G__54649) : debux.common.util.remove_d.call(null,G__54648,G__54649));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54650 = quoted_form;
var G__54651 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54650,G__54651) : debux.common.util.remove_d.call(null,G__54650,G__54651));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__54680__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54652 = quoted_form;
var G__54653 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54652,G__54653) : debux.common.util.remove_d.call(null,G__54652,G__54653));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__54680 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__54681__i = 0, G__54681__a = new Array(arguments.length -  0);
while (G__54681__i < G__54681__a.length) {G__54681__a[G__54681__i] = arguments[G__54681__i + 0]; ++G__54681__i;}
  arg = new cljs.core.IndexedSeq(G__54681__a,0,null);
} 
return G__54680__delegate.call(this,arg);};
G__54680.cljs$lang$maxFixedArity = 0;
G__54680.cljs$lang$applyTo = (function (arglist__54682){
var arg = cljs.core.seq(arglist__54682);
return G__54680__delegate(arg);
});
...
var G__54683 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__54683;
continue;
} else {
...
var G__54684 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__54684;
continue;
} else {
var G__54685 = clojure.zip.next(loc);
loc = G__54685;
continue;
