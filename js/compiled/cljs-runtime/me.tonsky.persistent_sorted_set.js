...
me.tonsky.persistent_sorted_set.level_shift = (cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__40713_SHARP_){
return (((32) & (1 << p1__40713_SHARP_)) != 0);
...
if((((idx < arr_l)) && (((0) === (function (){var G__40718 = (arr[idx]);
var G__40719 = key;
return (cmp.cljs$core$IFn$_invoke$arity$2 ? cmp.cljs$core$IFn$_invoke$arity$2(G__40718,G__40719) : cmp.call(null,G__40718,G__40719));
})())))){
return idx;
} else {
return (-1);
...
var l__40620__auto___40797 = (splice_from - cut_from);
var n__4613__auto___40798 = l__40620__auto___40797;
var i__40621__auto___40799 = (0);
while(true){
if((i__40621__auto___40799 < n__4613__auto___40798)){
(new_arr[(i__40621__auto___40799 + (0))] = (arr[(i__40621__auto___40799 + cut_from)]));

var G__40800 = (i__40621__auto___40799 + (1));
i__40621__auto___40799 = G__40800;
continue;
} else {
}
break;
...
var l__40620__auto___40801 = (xs_l - (0));
...
(new_arr[(i__40621__auto___40803 + l1)] = (xs[(i__40621__auto___40803 + (0))]));
...
var l__40620__auto___40805 = (cut_to - splice_to);
var n__4613__auto___40806 = l__40620__auto___40805;
var i__40621__auto___40807 = (0);
while(true){
if((i__40621__auto___40807 < n__4613__auto___40806)){
(new_arr[(i__40621__auto___40807 + l1xs)] = (arr[(i__40621__auto___40807 + splice_to)]));

var G__40808 = (i__40621__auto___40807 + (1));
i__40621__auto___40807 = G__40808;
continue;
} else {
}
break;
...
if((a1_l <= r1_l)){
var l__40620__auto___40809 = (a1_l - (0));
var n__4613__auto___40810 = l__40620__auto___40809;
...
var me$tonsky$persistent_sorted_set$INode$node_lim_key$dyn_40841 = (function (_){
...
return me$tonsky$persistent_sorted_set$INode$node_lim_key$dyn_40841(_);
}
});

var me$tonsky$persistent_sorted_set$INode$node_len$dyn_40844 = (function (_){
var x__4428__auto__ = (((_ == null))?null:_);
...
return me$tonsky$persistent_sorted_set$INode$node_len$dyn_40844(_);
}
});
...
var me$tonsky$persistent_sorted_set$INode$node_lookup$dyn_40851 = (function (_,cmp,key){
var x__4428__auto__ = (((_ == null))?null:_);
...
return me$tonsky$persistent_sorted_set$INode$node_lookup$dyn_40851(_,cmp,key);
}
});
...
var me$tonsky$persistent_sorted_set$INode$node_disj$dyn_40855 = (function (_,cmp,key,root_QMARK_,left,right){
var x__4428__auto__ = (((_ == null))?null:_);
...
return me$tonsky$persistent_sorted_set$INode$node_disj$dyn_40855(_,cmp,key,root_QMARK_,left,right);
}
});
...
var self__ = this;
var ___$1 = this;
var arr__40648__auto__ = self__.keys;
return (arr__40648__auto__[(arr__40648__auto__.length - (1))]);
}));
...
while(true){
if((level > (0))){
var G__40921 = (level - me.tonsky.persistent_sorted_set.level_shift);
var G__40922 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__40921;
node = G__40922;
continue;
} else {
...
while(true){
if((level__$1 > (0))){
var G__40934 = (function (){var arr__40648__auto__ = node__$1.pointers;
return (arr__40648__auto__[(arr__40648__auto__.length - (1))]);
})();
var G__40935 = me.tonsky.persistent_sorted_set.path_set(path,level__$1,(node__$1.pointers.length - (1)));
var G__40936 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
node__$1 = G__40934;
path = G__40935;
level__$1 = G__40936;
continue;
...
var me$tonsky$persistent_sorted_set$IIter$_copy$dyn_40963 = (function (this$,left,right){
...
return me$tonsky$persistent_sorted_set$IIter$_copy$dyn_40963(this$,left,right);
}
});
...
var G__40992 = (left__$1 + (1));
var G__40993 = keys__$1;
var G__40994 = (idx__$1 + (1));
var G__40995 = new_acc;
left__$1 = G__40992;
keys__$1 = G__40993;
idx__$1 = G__40994;
acc = G__40995;
...
var G__40998 = new_left;
var G__40999 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__41000 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
var G__41001 = new_acc;
left__$1 = G__40998;
keys__$1 = G__40999;
idx__$1 = G__41000;
acc = G__41001;
...
var G__41023 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__41024 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__41023;
res = G__41024;
continue;
}
...
var G__41029 = (node.pointers[idx]);
var G__41030 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__41031 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__41029;
path = G__41030;
level = G__41031;
continue;
...
var G__41036 = (node.pointers[idx]);
var G__41037 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__41038 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__41036;
path = G__41037;
level = G__41038;
continue;
...
var pos_41047 = (0);
while(true){
var rest_41048 = (len - pos_41047);
if((rest_41048 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41047));
} else {
if((rest_41048 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41047,(pos_41047 + chunk_len)));

var G__41052 = (pos_41047 + chunk_len);
pos_41047 = G__41052;
continue;
} else {
var piece_len_41055 = (rest_41048 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41047,(pos_41047 + piece_len_41055)));

var G__41056 = (pos_41047 + piece_len_41055);
pos_41047 = G__41056;
continue;
...
var G__41065 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,e);
var G__41066 = (i + (1));
var G__41067 = e;
acc = G__41065;
i = G__41066;
...
break;
default:
var G__41096 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__40773,leaves){
...
var G__41097 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__41096;
shift = G__41097;
continue;
...
args_arr__4757__auto__.push((arguments[i__4737__auto___41100]));
...
args_arr__4757__auto__.push((arguments[i__4737__auto___41109]));

var G__41115 = (i__4737__auto___41109 + (1));
i__4737__auto___41109 = G__41115;
continue;
} else {
}
break;
