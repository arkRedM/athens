...
if(cljs.core.truth_((function (){var fexpr__52725 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__52725.cljs$core$IFn$_invoke$arity$1 ? fexpr__52725.cljs$core$IFn$_invoke$arity$1(type) : fexpr__52725.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__52730 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__52730.cljs$core$IFn$_invoke$arity$1 ? fexpr__52730.cljs$core$IFn$_invoke$arity$1(type) : fexpr__52730.call(null,type));
})())){
} else {
...
var G__52731 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__52731)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__52731)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__52731)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__52731)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52731)].join('')));
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq52736){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52737,G__52738,seq52736__$2);
}));
