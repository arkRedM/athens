...
if(cljs.core.truth_((function (){var fexpr__52737 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__52737.cljs$core$IFn$_invoke$arity$1 ? fexpr__52737.cljs$core$IFn$_invoke$arity$1(type) : fexpr__52737.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__52743 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__52743.cljs$core$IFn$_invoke$arity$1 ? fexpr__52743.cljs$core$IFn$_invoke$arity$1(type) : fexpr__52743.call(null,type));
})())){
} else {
...
var G__52748 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__52748)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__52748)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__52748)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__52748)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52748)].join('')));
...
var len__4736__auto___52801 = arguments.length;
var i__4737__auto___52802 = (0);
while(true){
if((i__4737__auto___52802 < len__4736__auto___52801)){
args__4742__auto__.push((arguments[i__4737__auto___52802]));

var G__52803 = (i__4737__auto___52802 + (1));
i__4737__auto___52802 = G__52803;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__52760){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__52767 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__52767) : instaparse.reduction.node_builders.call(null,G__52767));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq52753){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52754,G__52755,seq52753__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___52810 = arguments.length;
var i__4737__auto___52811 = (0);
while(true){
if((i__4737__auto___52811 < len__4736__auto___52810)){
args__4742__auto__.push((arguments[i__4737__auto___52811]));

var G__52812 = (i__4737__auto___52811 + (1));
i__4737__auto___52811 = G__52812;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__52771){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__52774 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__52774) : instaparse.reduction.node_builders.call(null,G__52774));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq52768){
var G__52769 = cljs.core.first(seq52768);
var seq52768__$1 = cljs.core.next(seq52768);
var G__52770 = cljs.core.first(seq52768__$1);
var seq52768__$2 = cljs.core.next(seq52768__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52769,G__52770,seq52768__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k52776,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k52776,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__52782){
var vec__52783 = p__52782;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52783,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52783,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this52777,other52778){
var self__ = this;
var this52777__$1 = this;
return (((!((other52778 == null)))) && ((this52777__$1.constructor === other52778.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52777__$1.grammar,other52778.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52777__$1.start_production,other52778.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52777__$1.output_format,other52778.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52777__$1.__extmap,other52778.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__52775){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__52786 = cljs.core.keyword_identical_QMARK_;
var expr__52787 = k__4388__auto__;
if(cljs.core.truth_((pred__52786.cljs$core$IFn$_invoke$arity$2 ? pred__52786.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__52787) : pred__52786.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__52787)))){
return (new instaparse.core.Parser(G__52775,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52786.cljs$core$IFn$_invoke$arity$2 ? pred__52786.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__52787) : pred__52786.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__52787)))){
return (new instaparse.core.Parser(self__.grammar,G__52775,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52786.cljs$core$IFn$_invoke$arity$2 ? pred__52786.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__52787) : pred__52786.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__52787)))){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__52775,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__52775),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__52775){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__52775,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__52789 = (arguments.length - (1));
switch (G__52789) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args52780){
var self__ = this;
var self____$1 = this;
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__52779){
var extmap__4419__auto__ = (function (){var G__52790 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__52779,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__52779)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__52790);
} else {
return G__52790;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__52779),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__52779),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__52779),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var args__4742__auto__ = [];
var len__4736__auto___52868 = arguments.length;
var i__4737__auto___52869 = (0);
while(true){
if((i__4737__auto___52869 < len__4736__auto___52868)){
args__4742__auto__.push((arguments[i__4737__auto___52869]));

var G__52870 = (i__4737__auto___52869 + (1));
i__4737__auto___52869 = G__52870;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__52793){
...
var _STAR_case_insensitive_literals_STAR__orig_val__52796 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__52797 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__52797);

try{var G__52798 = input_format;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52798__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__52796);
}});
...
var map__52799 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52799__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52799__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq52791){
