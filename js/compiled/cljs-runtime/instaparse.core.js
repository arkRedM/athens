...
if(cljs.core.truth_((function (){var fexpr__52696 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__52696.cljs$core$IFn$_invoke$arity$1 ? fexpr__52696.cljs$core$IFn$_invoke$arity$1(type) : fexpr__52696.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__52697 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
...
var G__52702 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__52702)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__52702)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__52702)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__52702)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52702)].join('')));
...
var G__52783 = (i__4737__auto___52781 + (1));
i__4737__auto___52781 = G__52783;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__52718){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__52726 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__52726) : instaparse.reduction.node_builders.call(null,G__52726));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq52715){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52716,G__52717,seq52715__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___52790 = arguments.length;
var i__4737__auto___52791 = (0);
while(true){
if((i__4737__auto___52791 < len__4736__auto___52790)){
args__4742__auto__.push((arguments[i__4737__auto___52791]));

var G__52793 = (i__4737__auto___52791 + (1));
i__4737__auto___52791 = G__52793;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__52742){
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq52735){
...
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52736,G__52737,seq52735__$2);
}));
...
while(true){
if((i__4737__auto___52862 < len__4736__auto___52860)){
args__4742__auto__.push((arguments[i__4737__auto___52862]));

var G__52864 = (i__4737__auto___52862 + (1));
i__4737__auto___52862 = G__52864;
continue;
} else {
}
break;
