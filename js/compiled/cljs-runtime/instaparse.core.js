...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__48288){
var vec__48289 = p__48288;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48289,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48289,(1),null);
...
var pred__48313 = cljs.core.keyword_identical_QMARK_;
var expr__48314 = k__4388__auto__;
if(cljs.core.truth_((pred__48313.cljs$core$IFn$_invoke$arity$2 ? pred__48313.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__48314) : pred__48313.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__48314)))){
...
if(cljs.core.truth_((pred__48313.cljs$core$IFn$_invoke$arity$2 ? pred__48313.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__48314) : pred__48313.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__48314)))){
return (new instaparse.core.Parser(self__.grammar,G__48277,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__48313.cljs$core$IFn$_invoke$arity$2 ? pred__48313.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__48314) : pred__48313.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__48314)))){
