...
if(cljs.core.truth_((function (){var fexpr__52694 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__52694.cljs$core$IFn$_invoke$arity$1 ? fexpr__52694.cljs$core$IFn$_invoke$arity$1(type) : fexpr__52694.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__52695 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__52695.cljs$core$IFn$_invoke$arity$1 ? fexpr__52695.cljs$core$IFn$_invoke$arity$1(type) : fexpr__52695.call(null,type));
})())){
} else {
...
var G__52696 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__52696)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__52696)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__52696)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__52696)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52696)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__52700){
var map__52701 = p__52700;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__52705 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__52705) : instaparse.reduction.node_builders.call(null,G__52705));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq52697){
var G__52698 = cljs.core.first(seq52697);
var seq52697__$1 = cljs.core.next(seq52697);
var G__52699 = cljs.core.first(seq52697__$1);
var seq52697__$2 = cljs.core.next(seq52697__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52698,G__52699,seq52697__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___52792 = arguments.length;
var i__4737__auto___52793 = (0);
while(true){
if((i__4737__auto___52793 < len__4736__auto___52792)){
args__4742__auto__.push((arguments[i__4737__auto___52793]));

var G__52796 = (i__4737__auto___52793 + (1));
i__4737__auto___52793 = G__52796;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__52711){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__52716 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__52716) : instaparse.reduction.node_builders.call(null,G__52716));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq52708){
...
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52709,G__52710,seq52708__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k52719,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k52719,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__52734){
var vec__52736 = p__52734;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52736,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52736,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this52720,other52721){
var self__ = this;
var this52720__$1 = this;
return (((!((other52721 == null)))) && ((this52720__$1.constructor === other52721.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52720__$1.grammar,other52721.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52720__$1.start_production,other52721.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52720__$1.output_format,other52721.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52720__$1.__extmap,other52721.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__52718){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__52758 = cljs.core.keyword_identical_QMARK_;
var expr__52759 = k__4388__auto__;
if(cljs.core.truth_((pred__52758.cljs$core$IFn$_invoke$arity$2 ? pred__52758.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__52759) : pred__52758.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__52759)))){
return (new instaparse.core.Parser(G__52718,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52758.cljs$core$IFn$_invoke$arity$2 ? pred__52758.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__52759) : pred__52758.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__52759)))){
return (new instaparse.core.Parser(self__.grammar,G__52718,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52758.cljs$core$IFn$_invoke$arity$2 ? pred__52758.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__52759) : pred__52758.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__52759)))){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__52718,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__52718),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__52718){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__52718,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__52765 = (arguments.length - (1));
switch (G__52765) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args52723){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args52723)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__52722){
var extmap__4419__auto__ = (function (){var G__52770 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__52722,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__52722)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__52770);
} else {
return G__52770;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__52722),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__52722),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__52722),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var args__4742__auto__ = [];
var len__4736__auto___52878 = arguments.length;
var i__4737__auto___52879 = (0);
while(true){
if((i__4737__auto___52879 < len__4736__auto___52878)){
args__4742__auto__.push((arguments[i__4737__auto___52879]));

var G__52880 = (i__4737__auto___52879 + (1));
i__4737__auto___52879 = G__52880;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__52773){
...
var _STAR_case_insensitive_literals_STAR__orig_val__52776 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__52777 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__52777);

try{var G__52778 = input_format;
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__52776);
}});
...
var map__52779 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52779__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52779__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq52771){
var G__52772 = cljs.core.first(seq52771);
var seq52771__$1 = cljs.core.next(seq52771);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52772,seq52771__$1);
}));
