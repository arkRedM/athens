...
var temp__5733__auto___20668 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20668)){
var seen_errors_20669 = temp__5733__auto___20668;
if(cljs.core.truth_(seen_errors_20669.has(self))){
} else {
seen_errors_20669.add(self);
