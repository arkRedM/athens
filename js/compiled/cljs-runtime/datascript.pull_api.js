...
var G__42242 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__42242__$1 = (((G__42242 == null))?null:cljs.core.persistent_BANG_(G__42242));
if((G__42242__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__42242__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__42246){
...
var frame = first__42249;
var frames = seq__42248__$1;
...
var results = (function (){var G__42250 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__42250,kvps);
} else {
return G__42250;
}
})();
...
var pattern_42351 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_42351,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__42273){
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__42281){
var vec__42284 = p__42281;
var seq__42285 = cljs.core.seq(vec__42284);
var first__42286 = cljs.core.first(seq__42285);
var seq__42285__$1 = cljs.core.next(seq__42285);
var frame = first__42286;
var frames = seq__42285__$1;
...
var vec__42287 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42287,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42287,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42294__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42294__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__42299 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__42299,attr,eid);
} else {
return G__42299;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42303__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42303__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__42305){
while(true){
...
var frame = first__42308;
var frames = seq__42307__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__42356 = db;
var G__42357 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__42356;
p__42305 = G__42357;
continue;
}
...
while(true){
var G__42317 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__42317__$1 = (((G__42317 instanceof cljs.core.Keyword))?G__42317.fqn:null);
switch (G__42317__$1) {
case "expand":
var G__42360 = db;
var G__42361 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__42360;
frames = G__42361;
continue;
...
case "expand-rev":
var G__42362 = db;
var G__42363 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__42362;
frames = G__42363;
continue;
...
case "pattern":
var G__42364 = db;
var G__42365 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__42364;
frames = G__42365;
continue;
...
case "recursion":
var G__42366 = db;
var G__42367 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__42366;
frames = G__42367;
continue;
...
break;
case "done":
var vec__42321 = frames;
var seq__42322 = cljs.core.seq(vec__42321);
var first__42323 = cljs.core.first(seq__42322);
var seq__42322__$1 = cljs.core.next(seq__42322);
var f = first__42323;
var remaining = seq__42322__$1;
var result = (function (){var G__42324 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__42324);
} else {
return G__42324;
}
})();
...
var G__42376 = db;
var G__42377 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__42328 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__42328,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__42328;
}
})());
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__42332_SHARP_){
return datascript.db.entid_strict(db,p1__42332_SHARP_);
})),eids);
