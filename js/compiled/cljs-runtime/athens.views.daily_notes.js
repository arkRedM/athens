...
var G__66617__$5 = (((G__66617__$4 == null))?null:posh.reagent.pull_many(athens.db.dsdb,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null),G__66617__$4));
if((G__66617__$5 == null)){
return null;
} else {
return cljs.core.deref(G__66617__$5);
}
})();
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#daily-notes","div#daily-notes",-1983155722),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.daily_notes.daily_notes_scroll_area_style),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4529__auto__ = (function athens$views$daily_notes$daily_notes_panel_$_iter__66618(s__66619){
return (new cljs.core.LazySeq(null,(function (){
var s__66619__$1 = s__66619;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__66619__$1);
if(temp__5735__auto__){
var s__66619__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__66619__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__66619__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__66621 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__66620 = (0);
while(true){
if((i__66620 < size__4528__auto__)){
var map__66622 = cljs.core._nth(c__4527__auto__,i__66620);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__66621),athens$views$daily_notes$daily_notes_panel_$_iter__66618(cljs.core.chunk_rest(s__66619__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__66621),null);
}
} else {
var map__66624 = cljs.core.first(s__66619__$2);
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66624__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.daily_notes.daily_notes_page_style),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.node_page.node_page_component,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null)], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$views$daily_notes$daily_notes_panel_$_iter__66618(cljs.core.rest(s__66619__$2)));
}
} else {
return null;
}
