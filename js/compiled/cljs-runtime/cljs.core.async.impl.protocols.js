...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_60285 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_60285(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_60286 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_60286(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_60289 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_60289(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_60290 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_60290(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_60298 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_60298(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_60305 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_60305(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_60309 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_60309(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_60310 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_60310(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_60313 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_60313(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_60318 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_60318(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_60319 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_60319(b);
}
});
