...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_60260 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_60260(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_60263 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_60263(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_60271 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_60271(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_60278 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_60278(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_60282 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_60282(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_60285 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_60285(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_60290 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_60290(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_60291 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_60291(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_60292 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_60292(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_60295 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_60295(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_60300 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_60300(b);
}
});
