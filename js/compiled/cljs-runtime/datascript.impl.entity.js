...
var G__42310 = db;
var G__42311 = e;
var G__42312 = cljs.core.volatile_BANG_(false);
var G__42313 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__42310,G__42311,G__42312,G__42313) : datascript.impl.entity.__GT_Entity.call(null,G__42310,G__42311,G__42312,G__42313));
} else {
return null;
}
});
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__42314_SHARP_,p2__42315_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__42314_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__42315_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__42316_SHARP_,p2__42317_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__42316_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__42317_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__42318_SHARP_,p2__42319_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__42318_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__42319_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__4529__auto__ = (function datascript$impl$entity$js_seq_$_iter__42320(s__42321){
return (new cljs.core.LazySeq(null,(function (){
var s__42321__$1 = s__42321;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__42321__$1);
if(temp__5735__auto__){
var s__42321__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__42321__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__42321__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__42323 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__42322 = (0);
while(true){
if((i__42322 < size__4528__auto__)){
var vec__42326 = cljs.core._nth(c__4527__auto__,i__42322);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42326,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42326,(1),null);
cljs.core.chunk_append(b__42323,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__42516 = (i__42322 + (1));
i__42322 = G__42516;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42323),datascript$impl$entity$js_seq_$_iter__42320(cljs.core.chunk_rest(s__42321__$2)));
} else {
...
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__42320(cljs.core.rest(s__42321__$2)));
}
} else {
return null;
}
...
var G__42517 = null;
var G__42517__1 = (function (f){
var self__ = this;
var this$ = this;
var seq__42340 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__42341 = null;
var count__42342 = (0);
var i__42343 = (0);
while(true){
if((i__42343 < count__42342)){
var vec__42362 = chunk__42341.cljs$core$IIndexed$_nth$arity$2(null,i__42343);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42362,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42362,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__42520 = seq__42340;
var G__42521 = chunk__42341;
var G__42522 = count__42342;
var G__42523 = (i__42343 + (1));
seq__42340 = G__42520;
chunk__42341 = G__42521;
count__42342 = G__42522;
i__42343 = G__42523;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__42340);
if(temp__5735__auto__){
var seq__42340__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__42340__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__42340__$1);
var G__42524 = cljs.core.chunk_rest(seq__42340__$1);
var G__42525 = c__4556__auto__;
var G__42526 = cljs.core.count(c__4556__auto__);
var G__42527 = (0);
seq__42340 = G__42524;
chunk__42341 = G__42525;
count__42342 = G__42526;
i__42343 = G__42527;
continue;
} else {
var vec__42369 = cljs.core.first(seq__42340__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42369,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42369,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__42528 = cljs.core.next(seq__42340__$1);
var G__42529 = null;
var G__42530 = (0);
var G__42531 = (0);
seq__42340 = G__42528;
chunk__42341 = G__42529;
count__42342 = G__42530;
i__42343 = G__42531;
continue;
}
} else {
...
var G__42517__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__42372 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__42373 = null;
var count__42374 = (0);
var i__42375 = (0);
while(true){
if((i__42375 < count__42374)){
var vec__42405 = chunk__42373.cljs$core$IIndexed$_nth$arity$2(null,i__42375);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42405,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42405,(1),null);
f.call(use_as_this,v,a,this$);


var G__42534 = seq__42372;
var G__42535 = chunk__42373;
var G__42536 = count__42374;
var G__42537 = (i__42375 + (1));
seq__42372 = G__42534;
chunk__42373 = G__42535;
count__42374 = G__42536;
i__42375 = G__42537;
continue;
} else {
...
var c__4556__auto__ = cljs.core.chunk_first(seq__42372__$1);
var G__42538 = cljs.core.chunk_rest(seq__42372__$1);
var G__42539 = c__4556__auto__;
var G__42540 = cljs.core.count(c__4556__auto__);
var G__42541 = (0);
seq__42372 = G__42538;
chunk__42373 = G__42539;
count__42374 = G__42540;
i__42375 = G__42541;
continue;
} else {
var vec__42417 = cljs.core.first(seq__42372__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42417,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42417,(1),null);
f.call(use_as_this,v,a,this$);


var G__42543 = cljs.core.next(seq__42372__$1);
var G__42544 = null;
var G__42545 = (0);
var G__42546 = (0);
seq__42372 = G__42543;
chunk__42373 = G__42544;
count__42374 = G__42545;
i__42375 = G__42546;
continue;
}
} else {
...
G__42517 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__42517__1.call(this,f);
case 2:
return G__42517__2.call(this,f,use_as_this);
}
...
var G__42431 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__42431);
} else {
return G__42431;
}
}
...
var self__ = this;
var self__ = this;
var G__42456 = (arguments.length - (1));
switch (G__42456) {
case (1):
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args42338){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args42338)));
}));
...
var temp__5737__auto__ = (function (){var fexpr__42487 = cljs.core.deref(this$.cache);
return (fexpr__42487.cljs$core$IFn$_invoke$arity$1 ? fexpr__42487.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__42487.call(null,attr));
})();
...
var temp__5735__auto___42575 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5735__auto___42575)){
var datoms_42576 = temp__5735__auto___42575;
