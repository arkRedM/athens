...
if((c === "\n")){
var G__29653 = escape_QMARK_;
var G__29654 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__29653;
lines = G__29654;
continue;
} else {
buf.append(c);

var G__29655 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__29656 = lines;
escape_QMARK_ = G__29655;
lines = G__29656;
continue;
