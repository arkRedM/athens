...
var fexpr__55509 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__55509.cljs$core$IFn$_invoke$arity$1 ? fexpr__55509.cljs$core$IFn$_invoke$arity$1(type) : fexpr__55509.call(null,type));
});
...
var G__55539 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__55539;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__55510 = spec_tools.impl.normalize_symbol(x);
var G__55511 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__55510,G__55511) : spec_tools.parse.parse_form.call(null,G__55510,G__55511));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__55512 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__55513 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__55512,G__55513) : spec_tools.parse.parse_form.call(null,G__55512,G__55513));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__55540 = cljs.spec.alpha.form(x);
x = G__55540;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__55514 = spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x);
var G__55515 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__55514,G__55515) : spec_tools.parse.parse_form.call(null,G__55514,G__55515));
} else {
...
var G__55517 = parse_data;
var G__55517__$1 = (((G__55517 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__55517));
var G__55517__$2 = (((G__55517__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__55517__$1));
var G__55517__$3 = (((G__55517__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__55517__$2));
var G__55517__$4 = (((G__55517__$3 == null))?null:cljs.core.seq(G__55517__$3));
if((G__55517__$4 == null)){
return null;
} else {
return cljs.core.set(G__55517__$4);
}
}
});
...
var map__55522 = spec_tools.impl.parse_keys(form);
var map__55522__$1 = (((((!((map__55522 == null))))?(((((map__55522.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55522.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55522):map__55522);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55522__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55522__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55522__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55522__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55522__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__55524 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__55524__$1 = (cljs.core.truth_((function (){var or__4126__auto__ = req;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55524,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__55524);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55524__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__55524__$1;
}
}));
...
var map__55525 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__55525__$1 = (((((!((map__55525 == null))))?(((((map__55525.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55525.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55525):map__55525);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55525__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__55527 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55527__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__55529){
var vec__55530 = p__55529;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55530,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55530,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55530,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__55533){
...
var ___$1 = first__55536;
var values = seq__55535__$1;
