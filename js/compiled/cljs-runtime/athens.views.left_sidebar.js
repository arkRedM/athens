...
athens.views.left_sidebar.shortcut_component = (function athens$views$left_sidebar$shortcut_component(p__68663){
var vec__68664 = p__68663;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68664,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68664,(1),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68664,(2),null);
var drag = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null);
return (function (p__68667){
var vec__68668 = p__68667;
var order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68668,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68668,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68668,(2),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([athens.views.left_sidebar.shortcut_style,(function (){var G__68671 = cljs.core.deref(drag);
var G__68671__$1 = (((G__68671 instanceof cljs.core.Keyword))?G__68671.fqn:null);
switch (G__68671__$1) {
case "above":
...
var source_order_68677 = parseInt(e.dataTransfer.getData("text/plain"));
cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([source_order_68677,order], 0));

if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(source_order_68677,order)){
} else {
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(source_order_68677,(order - (1)))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(drag),new cljs.core.Keyword(null,"above","above",-1286866470))))){
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(drag),new cljs.core.Keyword(null,"below","below",-926774883))){
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("left-sidebar","drop-below","left-sidebar/drop-below",1291292866),source_order_68677,order], null));
} else {
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("left-sidebar","drop-above","left-sidebar/drop-above",75584917),source_order_68677,order], null));
