...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__31682 = c;
var G__31682__$1 = (((G__31682 == null))?null:G__31682.prototype);
if((G__31682__$1 == null)){
return null;
} else {
return G__31682__$1.reagentRender;
}
})() == null)))));
});
...
var c = this;
var G__31767_31780 = goog.object.get(c,"cljsRatom");
if((G__31767_31780 == null)){
} else {
reagent.ratom.dispose_BANG_(G__31767_31780);
}
...
var G__31771 = o;
goog.object.set(G__31771,cljs.core.name(k),v);
