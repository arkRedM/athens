...
var dirpath_65103 = athens.electron.path.dirname(filepath);
athens.electron.fs.watch(dirpath_65103,(function (_event,filename){
...
var blocks_orig_65112 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__65079){
...
}),blocks_with_plain_links_65111);
var blocks_temp_65113 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__65082){
...
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),blocks_temp_65113], null));

re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),blocks_orig_65112], null));
...
var schema_version_65122 = cljs.core.second(cljs.core.first(schemas));
var G__65085_65123 = schema_version_65122;
switch (G__65085_65123) {
case (1):
cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([["Schema version ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(schema_version_65122)].join('')], 0));

break;
default:
alert(Error(["No matching case clause for schema version: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(schema_version_65122)].join('')));
