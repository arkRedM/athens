...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66989 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66989(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__66972 = (n - (1));
var G__66973 = cljs.core.rest(s);
var G__66974 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__66972,G__66973,G__66974) : sci.impl.max_or_throw.take_STAR_.call(null,G__66972,G__66973,G__66974));
})());
} else {
return null;
}
