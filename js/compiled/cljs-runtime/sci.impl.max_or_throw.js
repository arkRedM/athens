...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66948 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66948(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__66931 = (n - (1));
var G__66932 = cljs.core.rest(s);
var G__66933 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__66931,G__66932,G__66933) : sci.impl.max_or_throw.take_STAR_.call(null,G__66931,G__66932,G__66933));
})());
} else {
return null;
}
