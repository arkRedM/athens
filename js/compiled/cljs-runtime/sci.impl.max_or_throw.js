...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66987 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66987(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__66968 = (n - (1));
var G__66969 = cljs.core.rest(s);
var G__66970 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__66968,G__66969,G__66970) : sci.impl.max_or_throw.take_STAR_.call(null,G__66968,G__66969,G__66970));
})());
} else {
return null;
}
