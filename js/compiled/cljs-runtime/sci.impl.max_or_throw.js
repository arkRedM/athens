...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66927 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66927(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__66909 = (n - (1));
var G__66910 = cljs.core.rest(s);
var G__66911 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__66909,G__66910,G__66911) : sci.impl.max_or_throw.take_STAR_.call(null,G__66909,G__66910,G__66911));
})());
} else {
return null;
}
