...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66935 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66935(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__66923 = (n - (1));
var G__66924 = cljs.core.rest(s);
var G__66925 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__66923,G__66924,G__66925) : sci.impl.max_or_throw.take_STAR_.call(null,G__66923,G__66924,G__66925));
})());
} else {
return null;
}
