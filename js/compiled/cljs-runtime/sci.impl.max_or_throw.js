...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66924 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66924(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__66907 = (n - (1));
var G__66908 = cljs.core.rest(s);
var G__66909 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__66907,G__66908,G__66909) : sci.impl.max_or_throw.take_STAR_.call(null,G__66907,G__66908,G__66909));
})());
} else {
return null;
}
