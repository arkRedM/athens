...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66925 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66925(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__66905 = (n - (1));
var G__66906 = cljs.core.rest(s);
var G__66907 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__66905,G__66906,G__66907) : sci.impl.max_or_throw.take_STAR_.call(null,G__66905,G__66906,G__66907));
})());
} else {
return null;
}
