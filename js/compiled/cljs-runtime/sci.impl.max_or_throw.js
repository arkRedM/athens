...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66940 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66940(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__66927 = (n - (1));
var G__66928 = cljs.core.rest(s);
var G__66929 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__66927,G__66928,G__66929) : sci.impl.max_or_throw.take_STAR_.call(null,G__66927,G__66928,G__66929));
})());
} else {
return null;
}
