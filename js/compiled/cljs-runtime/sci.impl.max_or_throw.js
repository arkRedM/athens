...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66913 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_66913(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__66898 = (n - (1));
var G__66899 = cljs.core.rest(s);
var G__66900 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__66898,G__66899,G__66900) : sci.impl.max_or_throw.take_STAR_.call(null,G__66898,G__66899,G__66900));
})());
} else {
return null;
}
