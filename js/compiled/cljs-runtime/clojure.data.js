...
var clojure$data$EqualityPartition$equality_partition$dyn_20969 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_20969(x);
}
});
...
var fexpr__20945 = (function (){var G__20946 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20946__$1)].join('')));

}
})();
return (fexpr__20945.cljs$core$IFn$_invoke$arity$2 ? fexpr__20945.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__20945.call(null,a,b));
}));
/**
