...
var G__52141 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__52141)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__52141)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__52141)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52141)].join('')));
...
var G__52190 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__52191 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__52190;
v = G__52191;
continue;
} else {
var G__52192 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__52193 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__52192;
v = G__52193;
continue;
}
...
break;
case "\"":
var G__52194 = cljs.core.next(sq);
var G__52195 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__52194;
v = G__52195;
continue;
...
break;
default:
var G__52196 = cljs.core.next(sq);
var G__52197 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__52196;
v = G__52197;
continue;
...
while(true){
var G__52151 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__52151__$1 = (((G__52151 instanceof cljs.core.Keyword))?G__52151.fqn:null);
switch (G__52151__$1) {
case "rule":
var vec__52156 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52156,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52156,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__52159 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__52159) : instaparse.cfg.content.call(null,G__52159));
...
break;
case "paren":
var G__52200 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__52200;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__52160 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__52160) : instaparse.cfg.build_rule.call(null,G__52160));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__52161 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__52161) : instaparse.cfg.build_rule.call(null,G__52161));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__52163 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__52163) : instaparse.cfg.build_rule.call(null,G__52163));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__52164 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__52164) : instaparse.cfg.build_rule.call(null,G__52164));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__52165 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__52165) : instaparse.cfg.build_rule.call(null,G__52165));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__52166 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__52166) : instaparse.cfg.build_rule.call(null,G__52166));
})());
...
while(true){
var G__52167 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__52202 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__52202;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52167__$1)].join('')));
...
var valid_nts_52203 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__52168_52204 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__52169_52205 = null;
var count__52170_52206 = (0);
var i__52171_52207 = (0);
while(true){
if((i__52171_52207 < count__52170_52206)){
var nt_52208 = chunk__52169_52205.cljs$core$IIndexed$_nth$arity$2(null,i__52171_52207);
if(cljs.core.truth_((valid_nts_52203.cljs$core$IFn$_invoke$arity$1 ? valid_nts_52203.cljs$core$IFn$_invoke$arity$1(nt_52208) : valid_nts_52203.call(null,nt_52208)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_52208),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__52209 = seq__52168_52204;
var G__52210 = chunk__52169_52205;
var G__52211 = count__52170_52206;
var G__52212 = (i__52171_52207 + (1));
seq__52168_52204 = G__52209;
chunk__52169_52205 = G__52210;
count__52170_52206 = G__52211;
i__52171_52207 = G__52212;
continue;
} else {
var temp__5735__auto___52213 = cljs.core.seq(seq__52168_52204);
if(temp__5735__auto___52213){
var seq__52168_52214__$1 = temp__5735__auto___52213;
if(cljs.core.chunked_seq_QMARK_(seq__52168_52214__$1)){
var c__4556__auto___52215 = cljs.core.chunk_first(seq__52168_52214__$1);
var G__52216 = cljs.core.chunk_rest(seq__52168_52214__$1);
var G__52217 = c__4556__auto___52215;
var G__52218 = cljs.core.count(c__4556__auto___52215);
var G__52219 = (0);
seq__52168_52204 = G__52216;
chunk__52169_52205 = G__52217;
count__52170_52206 = G__52218;
i__52171_52207 = G__52219;
continue;
} else {
var nt_52220 = cljs.core.first(seq__52168_52214__$1);
if(cljs.core.truth_((valid_nts_52203.cljs$core$IFn$_invoke$arity$1 ? valid_nts_52203.cljs$core$IFn$_invoke$arity$1(nt_52220) : valid_nts_52203.call(null,nt_52220)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_52220),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__52221 = cljs.core.next(seq__52168_52214__$1);
var G__52222 = null;
var G__52223 = (0);
var G__52224 = (0);
seq__52168_52204 = G__52221;
chunk__52169_52205 = G__52222;
count__52170_52206 = G__52223;
i__52171_52207 = G__52224;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__52172_52225 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__52173_52226 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__52174_52227 = true;
var _STAR_print_fn_STAR__temp_val__52175_52228 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__52174_52227);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__52175_52228);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__52173_52226);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__52172_52225);
}
...
var len__4736__auto___52229 = arguments.length;
var i__4737__auto___52230 = (0);
while(true){
if((i__4737__auto___52230 < len__4736__auto___52229)){
args__4742__auto__.push((arguments[i__4737__auto___52230]));

var G__52231 = (i__4737__auto___52230 + (1));
i__4737__auto___52230 = G__52231;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__52178){
...
var opts = map__52179__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__52181 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__52182 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__52182);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4667__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__52183_52232 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__52184_52233 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__52185_52234 = true;
var _STAR_print_fn_STAR__temp_val__52186_52235 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__52185_52234);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__52186_52235);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__52184_52233);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__52183_52232);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__52181);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq52176){
