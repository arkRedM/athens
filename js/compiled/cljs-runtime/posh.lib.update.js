...
var vec__40386 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40386,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40386,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40386,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40386,(3),null);
...
var vec__40392 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40392,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40392,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40392,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40392,(3),null);
...
posh.lib.update.update_pull_many = (function posh$lib$update$update_pull_many(p__40395,storage_key){
...
var posh_tree = map__40396__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40396__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40396__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__40398 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40398,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40398,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40398,(2),null);
var eids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40398,(3),null);
...
posh.lib.update.update_q_with_dbvarmap = (function posh$lib$update$update_q_with_dbvarmap(p__40403,storage_key){
...
var posh_tree = map__40404__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40404__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40404__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));

var vec__40406 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40406,(0),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40406,(1),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40406,(2),null);
...
var poshdbmap = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__40409){
var vec__40410 = p__40409;
var db_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40410,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40410,(1),null);
return cljs.core.PersistentArrayMap.createAsIfByAssoc([db_sym,posh.lib.db.poshdb__GT_analyze_db(posh_tree,poshdb)]);
}),dbvarmap));
var fixed_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__40413){
var vec__40414 = p__40413;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40414,(0),null);
var arg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40414,(1),null);
...
var G__40417 = cljs.core.first(storage_key);
var G__40417__$1 = (((G__40417 instanceof cljs.core.Keyword))?G__40417.fqn:null);
switch (G__40417__$1) {
case "pull":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40417__$1)].join('')));
