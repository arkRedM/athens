...
var tick$interval$ITimeSpanable$temporal_value$dyn_46933 = (function (_){
...
return tick$interval$ITimeSpanable$temporal_value$dyn_46933(_);
}
});
...
var self__ = this;
var self__ = this;
var G__46725 = (arguments.length - (1));
switch (G__46725) {
case (2):
...
var pred__46731 = cljs.core.keyword_identical_QMARK_;
var expr__46732 = k__4388__auto__;
if(cljs.core.truth_((pred__46731.cljs$core$IFn$_invoke$arity$2 ? pred__46731.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"relations","relations",-427124442),expr__46732) : pred__46731.call(null,new cljs.core.Keyword(null,"relations","relations",-427124442),expr__46732)))){
 ...
 */
tick.interval.map__GT_GeneralRelation = (function tick$interval$map__GT_GeneralRelation(G__46714){
var extmap__4419__auto__ = (function (){var G__46737 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__46714,new cljs.core.Keyword(null,"relations","relations",-427124442));
if(cljs.core.record_QMARK_(G__46714)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46737);
} else {
return G__46737;
}
})();
return (new tick.interval.GeneralRelation(new cljs.core.Keyword(null,"relations","relations",-427124442).cljs$core$IFn$_invoke$arity$1(G__46714),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var tick$interval$IIntervalOps$slice$dyn_46957 = (function (this$,beginning,end){
...
return tick$interval$IIntervalOps$slice$dyn_46957(this$,beginning,end);
}
});

var tick$interval$IIntervalOps$splice$dyn_46959 = (function (this$,ival){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return tick$interval$IIntervalOps$splice$dyn_46959(this$,ival);
}
});

var tick$interval$IIntervalOps$split$dyn_46960 = (function (this$,t){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return tick$interval$IIntervalOps$split$dyn_46960(this$,t);
}
});
...
var G__46971 = cljs.core.rest(s__46757__$2);
s__46757__$1 = G__46971;
continue;
}
}
} else {
...
var G__46972 = cljs.core.rest(s__46755__$1);
s__46755__$1 = G__46972;
continue;
}
} else {
return null;
...
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46868,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46868,(1),null);
...
var G__46871 = r;
var G__46871__$1 = ((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(tick.core.beginning(cljs.core.first(coll)),tick.core.min_of_type(tick.core.beginning(cljs.core.first(coll)))))?(function (p1__46864_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [tick.interval.new_interval(tick.core.min_of_type(tick.core.beginning(cljs.core.first(coll))),tick.core.beginning(cljs.core.first(coll)))], null),p1__46864_SHARP_);
})(G__46871):G__46871);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(p1__46865_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [tick.interval.new_interval(tick.core.end(cljs.core.last(coll)),tick.core.max_of_type(tick.core.end(cljs.core.last(coll))))], null));
})(G__46871__$1);
} else {
return G__46871__$1;
}
...
/** @this {Function} */
(tick.interval.disjoin.cljs$lang$applyTo = (function (seq46875){
var G__46876 = cljs.core.first(seq46875);
var seq46875__$1 = cljs.core.next(seq46875);
var G__46877 = cljs.core.first(seq46875__$1);
var seq46875__$2 = cljs.core.next(seq46875__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46876,G__46877,seq46875__$2);
}));
...
break;
case "overlapped-by":
var vec__46918 = tick.interval.split_with_assert(ival,tick.core.end(group));
var seg1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46918,(0),null);
var seg2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46918,(1),null);
