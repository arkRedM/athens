...
var spec_tools$core$Coercion$_coerce$dyn_56353 = (function (this$,value,transformer,options){
...
return spec_tools$core$Coercion$_coerce$dyn_56353(this$,value,transformer,options);
}
});
...
var G__56419 = cljs.spec.alpha.get_spec(x);
x = G__56419;
continue;
} else {
...
var G__56420 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__56420;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__56452 = cljs.spec.alpha.get_spec(x);
x = G__56452;
continue;
} else {
