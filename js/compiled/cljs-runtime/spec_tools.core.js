...
var G__56415 = cljs.spec.alpha.get_spec(x);
x = G__56415;
continue;
} else {
...
var G__56419 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__56419;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__56455 = cljs.spec.alpha.get_spec(x);
x = G__56455;
continue;
} else {
