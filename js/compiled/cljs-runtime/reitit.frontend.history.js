...
var reitit$frontend$history$History$_href$dyn_58398 = (function (this$,path){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return reitit$frontend$history$History$_href$dyn_58398(this$,path);
}
});
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k58342,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__58347 = k58342;
var G__58347__$1 = (((G__58347 instanceof cljs.core.Keyword))?G__58347.fqn:null);
switch (G__58347__$1) {
case "on-navigate":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k58342,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__58348){
var vec__58349 = p__58348;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58349,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58349,(1),null);
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__58341){
var self__ = this;
var G__58341__$1 = this;
return (new cljs.core.RecordIter((0),G__58341__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),new cljs.core.Keyword(null,"router","router",1091916230),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this58343,other58344){
var self__ = this;
var this58343__$1 = this;
return (((!((other58344 == null)))) && ((this58343__$1.constructor === other58344.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58343__$1.on_navigate,other58344.on_navigate)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58343__$1.router,other58344.router)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58343__$1.popstate_listener,other58344.popstate_listener)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58343__$1.hashchange_listener,other58344.hashchange_listener)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58343__$1.last_fragment,other58344.last_fragment)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58343__$1.__extmap,other58344.__extmap)));
}));
...
var G__58353 = reitit.frontend.match_by_path(self__.router,path);
var G__58354 = this$__$1;
return (self__.on_navigate.cljs$core$IFn$_invoke$arity$2 ? self__.on_navigate.cljs$core$IFn$_invoke$arity$2(G__58353,G__58354) : self__.on_navigate.call(null,G__58353,G__58354));
}));
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__58341){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__58355 = cljs.core.keyword_identical_QMARK_;
var expr__58356 = k__4388__auto__;
if(cljs.core.truth_((pred__58355.cljs$core$IFn$_invoke$arity$2 ? pred__58355.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),expr__58356) : pred__58355.call(null,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),expr__58356)))){
return (new reitit.frontend.history.FragmentHistory(G__58341,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__58355.cljs$core$IFn$_invoke$arity$2 ? pred__58355.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"router","router",1091916230),expr__58356) : pred__58355.call(null,new cljs.core.Keyword(null,"router","router",1091916230),expr__58356)))){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,G__58341,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__58355.cljs$core$IFn$_invoke$arity$2 ? pred__58355.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),expr__58356) : pred__58355.call(null,new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),expr__58356)))){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,G__58341,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__58355.cljs$core$IFn$_invoke$arity$2 ? pred__58355.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),expr__58356) : pred__58355.call(null,new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),expr__58356)))){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,G__58341,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__58355.cljs$core$IFn$_invoke$arity$2 ? pred__58355.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173),expr__58356) : pred__58355.call(null,new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173),expr__58356)))){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,G__58341,self__.__meta,self__.__extmap,null));
} else {
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__58341),null));
}
}
}
}
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__58341){
var self__ = this;
var this__4379__auto____$1 = this;
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,G__58341,self__.__extmap,self__.__hash));
}));
 ...
 */
reitit.frontend.history.map__GT_FragmentHistory = (function reitit$frontend$history$map__GT_FragmentHistory(G__58345){
var extmap__4419__auto__ = (function (){var G__58358 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__58345,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"router","router",1091916230),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173)], 0));
if(cljs.core.record_QMARK_(G__58345)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__58358);
} else {
return G__58358;
}
})();
return (new reitit.frontend.history.FragmentHistory(new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908).cljs$core$IFn$_invoke$arity$1(G__58345),new cljs.core.Keyword(null,"router","router",1091916230).cljs$core$IFn$_invoke$arity$1(G__58345),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472).cljs$core$IFn$_invoke$arity$1(G__58345),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801).cljs$core$IFn$_invoke$arity$1(G__58345),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173).cljs$core$IFn$_invoke$arity$1(G__58345),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
(reitit.frontend.history.Html5History.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k58367,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__58371 = k58367;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k58367,else__4383__auto__);
...
(reitit.frontend.history.Html5History.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__58366){
var self__ = this;
...
(reitit.frontend.history.Html5History.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this58368,other58369){
var self__ = this;
var this58368__$1 = this;
return (((!((other58369 == null)))) && ((this58368__$1.constructor === other58369.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58368__$1.on_navigate,other58369.on_navigate)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58368__$1.router,other58369.router)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58368__$1.listen_key,other58369.listen_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58368__$1.click_listen_key,other58369.click_listen_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58368__$1.__extmap,other58369.__extmap)));
}));
...
(reitit.frontend.history.Html5History.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__58366){
var self__ = this;
var this__4387__auto____$1 = this;
...
return (new reitit.frontend.history.Html5History(G__58366,self__.router,self__.listen_key,self__.click_listen_key,self__.__meta,self__.__extmap,null));
} else {
...
return (new reitit.frontend.history.Html5History(self__.on_navigate,G__58366,self__.listen_key,self__.click_listen_key,self__.__meta,self__.__extmap,null));
} else {
...
return (new reitit.frontend.history.Html5History(self__.on_navigate,self__.router,G__58366,self__.click_listen_key,self__.__meta,self__.__extmap,null));
} else {
...
return (new reitit.frontend.history.Html5History(self__.on_navigate,self__.router,self__.listen_key,G__58366,self__.__meta,self__.__extmap,null));
} else {
return (new reitit.frontend.history.Html5History(self__.on_navigate,self__.router,self__.listen_key,self__.click_listen_key,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__58366),null));
}
}
}
}
...
(reitit.frontend.history.Html5History.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__58366){
var self__ = this;
var this__4379__auto____$1 = this;
return (new reitit.frontend.history.Html5History(self__.on_navigate,self__.router,self__.listen_key,self__.click_listen_key,G__58366,self__.__extmap,self__.__hash));
}));
 ...
 */
reitit.frontend.history.map__GT_Html5History = (function reitit$frontend$history$map__GT_Html5History(G__58370){
var extmap__4419__auto__ = (function (){var G__58381 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__58370,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"router","router",1091916230),new cljs.core.Keyword(null,"listen-key","listen-key",51973686),new cljs.core.Keyword(null,"click-listen-key","click-listen-key",642240955)], 0));
...
return (new reitit.frontend.history.Html5History(new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908).cljs$core$IFn$_invoke$arity$1(G__58370),new cljs.core.Keyword(null,"router","router",1091916230).cljs$core$IFn$_invoke$arity$1(G__58370),new cljs.core.Keyword(null,"listen-key","listen-key",51973686).cljs$core$IFn$_invoke$arity$1(G__58370),new cljs.core.Keyword(null,"click-listen-key","click-listen-key",642240955).cljs$core$IFn$_invoke$arity$1(G__58370),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
