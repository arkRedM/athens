...
return new cljs.core.Keyword("sci.impl","op","sci.impl/op",950953978).cljs$core$IFn$_invoke$arity$1(G__66653__$1);
}
});
...
var map__66658 = cljs.core.meta(iobj);
var map__66658__$1 = (((((!((map__66658 == null))))?(((((map__66658.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66658.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__66658):map__66658);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66658__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66658__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var map__66663 = cljs.core.meta(node);
...
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__66663__$1,new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(ctx));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__66663__$1,new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"column","column",2078222095).cljs$core$IFn$_invoke$arity$1(ctx));
...
var len__4736__auto___66690 = arguments.length;
var i__4737__auto___66691 = (0);
while(true){
if((i__4737__auto___66691 < len__4736__auto___66690)){
args__4742__auto__.push((arguments[i__4737__auto___66691]));

var G__66692 = (i__4737__auto___66691 + (1));
i__4737__auto___66691 = G__66692;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq66671){
...
var G__66681 = cljs.core.namespace(sym);
switch (G__66681) {
case "clojure.core":
case "cljs.core":
...
return (new cljs.core.MapEntry((function (){var G__66684 = cljs.core.key(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__66684) : inner.call(null,G__66684));
})(),(function (){var G__66685 = cljs.core.val(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__66685) : inner.call(null,G__66685));
})(),null));
} else {
