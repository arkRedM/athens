...
var G__23900_23904 = Error;
var target__20682__auto___23905 = G__23900_23904;
if(cljs.core.truth_(target__20682__auto___23905)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23900_23904)].join(''),"\n","target__20682__auto__"].join('')));
}

(target__20682__auto___23905["stackTraceLimit"] = Infinity);
