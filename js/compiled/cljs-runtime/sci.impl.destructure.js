...
var G__66716 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__66717 = n;
var G__66718 = cljs.core.nnext(bs);
var G__66719 = true;
ret = G__66716;
n = G__66717;
bs = G__66718;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__66697_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4126__auto__ = mkns;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return cljs.core.namespace(p1__66697_SHARP_);
}
})(),cljs.core.name(p1__66697_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__66698_SHARP_,p2__66699_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__66698_SHARP_,p2__66699_SHARP_,(function (){var fexpr__66713 = cljs.core.val(entry);
return (fexpr__66713.cljs$core$IFn$_invoke$arity$1 ? fexpr__66713.cljs$core$IFn$_invoke$arity$1(p2__66699_SHARP_) : fexpr__66713.call(null,p2__66699_SHARP_));
})());
...
var G__66724 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__66725 = cljs.core.next(bes);
ret = G__66724;
bes = G__66725;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__66700_SHARP_){
return (cljs.core.first(p1__66700_SHARP_) instanceof cljs.core.Keyword);
}),bents));
