...
}catch (e23545){var _e__20659__auto__ = e23545;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e23547){var _e__20659__auto__ = e23547;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23555 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23556 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23556);

try{var map__23557 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23557__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23555);
}});
...
var _STAR_print_level_STAR__orig_val__23564_23629 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23565_23630 = managed_print_level_23628;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23565_23630);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__23563_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__23563_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23564_23629);
}} else {
job_fn();
}
