...
var vec__52540 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52540,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52540,(1),null);
...
var vec__52543 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52543,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52543,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__52546 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52546,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52546,(1),null);
...
var G__52607 = cljs.core.next(parses__$1);
parses__$1 = G__52607;
continue;
}
...
var G__52554 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__52555 = G__52554;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52555,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52555,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52555,(2),null);
var selection = vec__52555;
...
var vec__52561 = G__52554__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52561,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52561,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52561,(2),null);
var selection__$1 = vec__52561;
...
var G__52609 = cljs.core.long$(end__$1);
var G__52610 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__52611 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__52609;
parses__$1 = G__52610;
G__52554__$1 = G__52611;
continue;
...
var G__52569 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__52570 = G__52569;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52570,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52570,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52570,(2),null);
var selection = vec__52570;
var index__$2 = index__$1;
var parses__$1 = parses;
...
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__52576 = G__52569__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52576,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52576,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52576,(2),null);
var selection__$1 = vec__52576;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__52613 = cljs.core.long$(end__$1);
var G__52614 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__52615 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__52613;
parses__$1 = G__52614;
G__52569__$1 = G__52615;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__52584 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__52585 = G__52584;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52585,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52585,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52585,(2),null);
var selection = vec__52585;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__52584__$1 = G__52584;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__52591 = G__52584__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52591,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52591,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52591,(2),null);
var selection__$1 = vec__52591;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__52617 = cljs.core.long$(end__$1);
var G__52618 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__52619 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__52617;
parses__$1 = G__52618;
G__52584__$1 = G__52619;
continue;
...
if(cljs.core.truth_((function (){var fexpr__52596 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__52596.cljs$core$IFn$_invoke$arity$1 ? fexpr__52596.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__52596.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4115__auto__ = (function (){var G__52605 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__52604 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
