...
var cond_splice_QMARK_ = (function (){var G__67218 = next_val;
var G__67218__$1 = (((G__67218 == null))?null:cljs.core.meta(G__67218));
if((G__67218__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("edamame.impl.parser","cond-splice","edamame.impl.parser/cond-splice",1534599765).cljs$core$IFn$_invoke$arity$1(G__67218__$1);
}
})();
...
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(vals,v_67320);


var G__67321 = cljs.core.next(seq__67219_67314__$1);
var G__67322 = null;
var G__67323 = (0);
var G__67324 = (0);
...
var G__67327 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(vals,next_val);
vals = G__67327;
continue;
...
var iter__4529__auto__ = (function edamame$impl$parser$duplicate_keys_error_$_duplicates_$_iter__67233(s__67234){
return (new cljs.core.LazySeq(null,(function (){
var s__67234__$1 = s__67234;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__67234__$1);
if(temp__5735__auto__){
var s__67234__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__67234__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__67234__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__67236 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__67235 = (0);
while(true){
if((i__67235 < size__4528__auto__)){
var vec__67237 = cljs.core._nth(c__4527__auto__,i__67235);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__67236),edamame$impl$parser$duplicate_keys_error_$_duplicates_$_iter__67233(cljs.core.chunk_rest(s__67234__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__67236),null);
}
} else {
var vec__67240 = cljs.core.first(s__67234__$2);
...
if(match_QMARK_){
var G__67334 = (edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2 ? edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2(ctx,reader) : edamame.impl.parser.parse_next.call(null,ctx,reader));
match = G__67334;
continue;
} else {
var G__67245_67335 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ctx,new cljs.core.Keyword("edamame.impl.parser","suppress","edamame.impl.parser/suppress",1718484755),true);
var G__67246_67336 = reader;
(edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2 ? edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2(G__67245_67335,G__67246_67336) : edamame.impl.parser.parse_next.call(null,G__67245_67335,G__67246_67336));
...
var G__67248 = cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4((edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2 ? edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2(ctx,reader) : edamame.impl.parser.parse_next.call(null,ctx,reader)),cljs.core.assoc,new cljs.core.Keyword("edamame","read-cond-splicing","edamame/read-cond-splicing",-1992728777),splice_QMARK_);
return (opt.cljs$core$IFn$_invoke$arity$1 ? opt.cljs$core$IFn$_invoke$arity$1(G__67248) : opt.call(null,G__67248));
} else {
reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
...
if(splice_QMARK_){
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(match,(function (p1__67247_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__67247_SHARP_,new cljs.core.Keyword("edamame.impl.parser","cond-splice","edamame.impl.parser/cond-splice",1534599765),true);
}));
} else {
return match;
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__67253)){
reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
...
var ks_67340 = cljs.core.take_nth.cljs$core$IFn$_invoke$arity$2((2),elements);
if(cljs.core.truth_(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.distinct_QMARK_,ks_67340))){
} else {
edamame.impl.parser.throw_dup_keys(reader,start_loc,new cljs.core.Keyword(null,"map","map",1371690461),ks_67340);
}
} else {
}
...
var vec__67254 = (edamame.impl.parser.parse_symbol.cljs$core$IFn$_invoke$arity$1 ? edamame.impl.parser.parse_symbol.cljs$core$IFn$_invoke$arity$1(token__$1) : edamame.impl.parser.parse_symbol.call(null,token__$1));
var token_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67254,(0),null);
var token_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67254,(1),null);
...
var G__67257 = c;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__67257)){
return new cljs.core.Keyword("edamame.impl.parser","eof","edamame.impl.parser/eof",720552006);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("@",G__67257)){
...
if(cljs.core.truth_(temp__5735__auto__)){
var map__67264 = temp__5735__auto__;
...
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67264__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67264__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var char$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67264__$1,new cljs.core.Keyword(null,"char","char",-641587586));
...
return edamame.impl.parser.throw_reader.cljs$core$IFn$_invoke$arity$4(reader,["Unmatched delimiter: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(c),(cljs.core.truth_(expected)?[", expected: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expected),(function (){var temp__5735__auto__ = new cljs.core.Keyword("edamame.impl.parser","opened-delimiter","edamame.impl.parser/opened-delimiter",1199661648).cljs$core$IFn$_invoke$arity$1(ctx);
if(cljs.core.truth_(temp__5735__auto__)){
var map__67272 = temp__5735__auto__;
var map__67272__$1 = (((((!((map__67272 == null))))?(((((map__67272.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67272.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__67272):map__67272);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67272__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67272__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var char$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67272__$1,new cljs.core.Keyword(null,"char","char",-641587586));
return [" to match ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(char$)," at ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [row,col], null))].join('');
} else {
return null;
}
...
return edamame.impl.parser.throw_reader.cljs$core$IFn$_invoke$arity$4(reader,["Unmatched delimiter: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(c),(cljs.core.truth_(expected)?[", expected: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expected),(function (){var temp__5735__auto__ = new cljs.core.Keyword("edamame.impl.parser","opened-delimiter","edamame.impl.parser/opened-delimiter",1199661648).cljs$core$IFn$_invoke$arity$1(ctx);
if(cljs.core.truth_(temp__5735__auto__)){
var map__67280 = temp__5735__auto__;
...
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67280__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67280__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var char$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67280__$1,new cljs.core.Keyword(null,"char","char",-641587586));
return [" to match ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(char$)," at ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [row,col], null))].join('');
} else {
return null;
}
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(obj,(function (p1__67282_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__67282_SHARP_,new cljs.core.Keyword(null,"row-key","row-key",-1189010712).cljs$core$IFn$_invoke$arity$1(ctx),new cljs.core.Keyword(null,"row","row",-570139521).cljs$core$IFn$_invoke$arity$1(loc),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"col-key","col-key",-2009675766).cljs$core$IFn$_invoke$arity$1(ctx),new cljs.core.Keyword(null,"col","col",-1959363084).cljs$core$IFn$_invoke$arity$1(loc),new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680).cljs$core$IFn$_invoke$arity$1(ctx),new cljs.core.Keyword(null,"row","row",-570139521).cljs$core$IFn$_invoke$arity$1(end_loc),new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304).cljs$core$IFn$_invoke$arity$1(ctx),new cljs.core.Keyword(null,"col","col",-1959363084).cljs$core$IFn$_invoke$arity$1(end_loc)], 0));
}));
} else {
return obj;
}
...
(edamame.impl.parser.Options.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k67285,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__67289 = k67285;
var G__67289__$1 = (((G__67289 instanceof cljs.core.Keyword))?G__67289.fqn:null);
switch (G__67289__$1) {
case "dispatch":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k67285,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__67290){
var vec__67291 = p__67290;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67291,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67291,(1),null);
...
(edamame.impl.parser.Options.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this67286,other67287){
var self__ = this;
var this67286__$1 = this;
return (((!((other67287 == null)))) && ((this67286__$1.constructor === other67287.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67286__$1.dispatch,other67287.dispatch)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67286__$1.deref,other67287.deref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67286__$1.syntax_quote,other67287.syntax_quote)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67286__$1.unquote,other67287.unquote)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67286__$1.unquote_splicing,other67287.unquote_splicing)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67286__$1.quote,other67287.quote)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67286__$1.fn,other67287.fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67286__$1.var,other67287.var)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67286__$1.read_eval,other67287.read_eval)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67286__$1.regex,other67287.regex)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67286__$1.row_key,other67287.row_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67286__$1.col_key,other67287.col_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67286__$1.end_row_key,other67287.end_row_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67286__$1.end_col_key,other67287.end_col_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67286__$1.__extmap,other67287.__extmap)));
}));
...
(edamame.impl.parser.Options.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__67284){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__67294 = cljs.core.keyword_identical_QMARK_;
var expr__67295 = k__4388__auto__;
if(cljs.core.truth_((pred__67294.cljs$core$IFn$_invoke$arity$2 ? pred__67294.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),expr__67295) : pred__67294.call(null,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),expr__67295)))){
return (new edamame.impl.parser.Options(G__67284,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67294.cljs$core$IFn$_invoke$arity$2 ? pred__67294.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"deref","deref",-145586795),expr__67295) : pred__67294.call(null,new cljs.core.Keyword(null,"deref","deref",-145586795),expr__67295)))){
return (new edamame.impl.parser.Options(self__.dispatch,G__67284,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67294.cljs$core$IFn$_invoke$arity$2 ? pred__67294.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"syntax-quote","syntax-quote",-1233164847),expr__67295) : pred__67294.call(null,new cljs.core.Keyword(null,"syntax-quote","syntax-quote",-1233164847),expr__67295)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,G__67284,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67294.cljs$core$IFn$_invoke$arity$2 ? pred__67294.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"unquote","unquote",1649741032),expr__67295) : pred__67294.call(null,new cljs.core.Keyword(null,"unquote","unquote",1649741032),expr__67295)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,G__67284,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67294.cljs$core$IFn$_invoke$arity$2 ? pred__67294.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"unquote-splicing","unquote-splicing",1295267556),expr__67295) : pred__67294.call(null,new cljs.core.Keyword(null,"unquote-splicing","unquote-splicing",1295267556),expr__67295)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,G__67284,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67294.cljs$core$IFn$_invoke$arity$2 ? pred__67294.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"quote","quote",-262615245),expr__67295) : pred__67294.call(null,new cljs.core.Keyword(null,"quote","quote",-262615245),expr__67295)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,G__67284,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67294.cljs$core$IFn$_invoke$arity$2 ? pred__67294.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"fn","fn",-1175266204),expr__67295) : pred__67294.call(null,new cljs.core.Keyword(null,"fn","fn",-1175266204),expr__67295)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,G__67284,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67294.cljs$core$IFn$_invoke$arity$2 ? pred__67294.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"var","var",-769682797),expr__67295) : pred__67294.call(null,new cljs.core.Keyword(null,"var","var",-769682797),expr__67295)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,G__67284,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67294.cljs$core$IFn$_invoke$arity$2 ? pred__67294.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"read-eval","read-eval",1788733932),expr__67295) : pred__67294.call(null,new cljs.core.Keyword(null,"read-eval","read-eval",1788733932),expr__67295)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,G__67284,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67294.cljs$core$IFn$_invoke$arity$2 ? pred__67294.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"regex","regex",939488856),expr__67295) : pred__67294.call(null,new cljs.core.Keyword(null,"regex","regex",939488856),expr__67295)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,G__67284,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67294.cljs$core$IFn$_invoke$arity$2 ? pred__67294.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"row-key","row-key",-1189010712),expr__67295) : pred__67294.call(null,new cljs.core.Keyword(null,"row-key","row-key",-1189010712),expr__67295)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,G__67284,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67294.cljs$core$IFn$_invoke$arity$2 ? pred__67294.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"col-key","col-key",-2009675766),expr__67295) : pred__67294.call(null,new cljs.core.Keyword(null,"col-key","col-key",-2009675766),expr__67295)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,G__67284,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67294.cljs$core$IFn$_invoke$arity$2 ? pred__67294.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680),expr__67295) : pred__67294.call(null,new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680),expr__67295)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,G__67284,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67294.cljs$core$IFn$_invoke$arity$2 ? pred__67294.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304),expr__67295) : pred__67294.call(null,new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304),expr__67295)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,G__67284,self__.__meta,self__.__extmap,null));
} else {
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__67284),null));
}
}
}
}
...
(edamame.impl.parser.Options.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__67284){
var self__ = this;
var this__4379__auto____$1 = this;
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,G__67284,self__.__extmap,self__.__hash));
}));
 ...
 */
edamame.impl.parser.map__GT_Options = (function edamame$impl$parser$map__GT_Options(G__67288){
var extmap__4419__auto__ = (function (){var G__67297 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__67288,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"deref","deref",-145586795),new cljs.core.Keyword(null,"syntax-quote","syntax-quote",-1233164847),new cljs.core.Keyword(null,"unquote","unquote",1649741032),new cljs.core.Keyword(null,"unquote-splicing","unquote-splicing",1295267556),new cljs.core.Keyword(null,"quote","quote",-262615245),new cljs.core.Keyword(null,"fn","fn",-1175266204),new cljs.core.Keyword(null,"var","var",-769682797),new cljs.core.Keyword(null,"read-eval","read-eval",1788733932),new cljs.core.Keyword(null,"regex","regex",939488856),new cljs.core.Keyword(null,"row-key","row-key",-1189010712),new cljs.core.Keyword(null,"col-key","col-key",-2009675766),new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680),new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304)], 0));
if(cljs.core.record_QMARK_(G__67288)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__67297);
} else {
return G__67297;
}
})();
return (new edamame.impl.parser.Options(new cljs.core.Keyword(null,"dispatch","dispatch",1319337009).cljs$core$IFn$_invoke$arity$1(G__67288),new cljs.core.Keyword(null,"deref","deref",-145586795).cljs$core$IFn$_invoke$arity$1(G__67288),new cljs.core.Keyword(null,"syntax-quote","syntax-quote",-1233164847).cljs$core$IFn$_invoke$arity$1(G__67288),new cljs.core.Keyword(null,"unquote","unquote",1649741032).cljs$core$IFn$_invoke$arity$1(G__67288),new cljs.core.Keyword(null,"unquote-splicing","unquote-splicing",1295267556).cljs$core$IFn$_invoke$arity$1(G__67288),new cljs.core.Keyword(null,"quote","quote",-262615245).cljs$core$IFn$_invoke$arity$1(G__67288),new cljs.core.Keyword(null,"fn","fn",-1175266204).cljs$core$IFn$_invoke$arity$1(G__67288),new cljs.core.Keyword(null,"var","var",-769682797).cljs$core$IFn$_invoke$arity$1(G__67288),new cljs.core.Keyword(null,"read-eval","read-eval",1788733932).cljs$core$IFn$_invoke$arity$1(G__67288),new cljs.core.Keyword(null,"regex","regex",939488856).cljs$core$IFn$_invoke$arity$1(G__67288),new cljs.core.Keyword(null,"row-key","row-key",-1189010712).cljs$core$IFn$_invoke$arity$1(G__67288),new cljs.core.Keyword(null,"col-key","col-key",-2009675766).cljs$core$IFn$_invoke$arity$1(G__67288),new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680).cljs$core$IFn$_invoke$arity$1(G__67288),new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304).cljs$core$IFn$_invoke$arity$1(G__67288),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var opts__$3 = (function (){var G__67298 = opts__$2;
var G__67298__$1 = ((cljs.core.not(new cljs.core.Keyword(null,"row-key","row-key",-1189010712).cljs$core$IFn$_invoke$arity$1(opts__$2)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67298,new cljs.core.Keyword(null,"row-key","row-key",-1189010712),new cljs.core.Keyword(null,"row","row",-570139521)):G__67298);
var G__67298__$2 = ((cljs.core.not(new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680).cljs$core$IFn$_invoke$arity$1(opts__$2)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67298__$1,new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680),new cljs.core.Keyword(null,"end-row","end-row",-545103581)):G__67298__$1);
var G__67298__$3 = ((cljs.core.not(new cljs.core.Keyword(null,"col-key","col-key",-2009675766).cljs$core$IFn$_invoke$arity$1(opts__$2)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67298__$2,new cljs.core.Keyword(null,"col-key","col-key",-2009675766),new cljs.core.Keyword(null,"col","col",-1959363084)):G__67298__$2);
if(cljs.core.not(new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304).cljs$core$IFn$_invoke$arity$1(opts__$2))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67298__$3,new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304),new cljs.core.Keyword(null,"end-col","end-col",-724155879));
} else {
return G__67298__$3;
}
})();
...
var G__67342 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,next_val);
ret = G__67342;
continue;
}
break;
