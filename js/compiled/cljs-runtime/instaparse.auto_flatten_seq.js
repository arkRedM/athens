...
var instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_51008 = (function (self,obj){
...
return instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_51008(self,obj);
}
});

var instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_51009 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_51009(self);
}
});
...
var G__51010 = n__$1;
var G__51011 = y;
var G__51012 = cljs.core.imul(z,z);
n = G__51010;
y = G__51011;
z = G__51012;
continue;
...
var G__51014 = n__$1;
var G__51015 = cljs.core.imul(z,y);
var G__51016 = cljs.core.imul(z,z);
n = G__51014;
y = G__51015;
z = G__51016;
continue;
...
var G__51018 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__51019 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__51018;
index__$1 = G__51019;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__50981 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__50981) : instaparse.auto_flatten_seq.true_count.call(null,G__50981));
})() - (1)))){
...
var G__51020 = v;
var G__51021 = cljs.core.pop(index);
v = G__51020;
index = G__51021;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__51026 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__51027 = cljs.core.next(coll__$1);
unmixed_hash = G__51026;
coll__$1 = G__51027;
continue;
} else {
return unmixed_hash;
...
var G__51028 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__51029 = cljs.core.next(v);
acc = G__51028;
v = G__51029;
continue;
} else {
var G__51030 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__51031 = cljs.core.next(v);
acc = G__51030;
v = G__51031;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_51032 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_51032(self);
}
});
...
var self__ = this;
var self__ = this;
var G__51003 = (arguments.length - (1));
switch (G__51003) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args51000){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args51000)));
}));
