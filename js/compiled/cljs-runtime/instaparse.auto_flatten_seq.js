...
var instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_51002 = (function (self,obj){
...
return instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_51002(self,obj);
}
});
...
if((cljs.core.peek(index) < ((function (){var G__50917 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__50917) : instaparse.auto_flatten_seq.true_count.call(null,G__50917));
})() - (1)))){
...
while(true){
if((!((coll__$1 == null)))){
var G__51018 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__51019 = cljs.core.next(coll__$1);
unmixed_hash = G__51018;
coll__$1 = G__51019;
continue;
} else {
return unmixed_hash;
...
var G__51020 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__51021 = cljs.core.next(v);
acc = G__51020;
v = G__51021;
continue;
} else {
var G__51022 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__51023 = cljs.core.next(v);
acc = G__51022;
v = G__51023;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_51025 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_51025(self);
}
});
...
var self__ = this;
var self__ = this;
var G__50995 = (arguments.length - (1));
switch (G__50995) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args50986){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args50986)));
}));
