...
var instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_50998 = (function (self,obj){
...
return instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_50998(self,obj);
}
});

var instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_50999 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_50999(self);
}
});
...
var G__51000 = n__$1;
var G__51001 = y;
var G__51002 = cljs.core.imul(z,z);
n = G__51000;
y = G__51001;
z = G__51002;
continue;
...
var G__51003 = n__$1;
var G__51004 = cljs.core.imul(z,y);
var G__51005 = cljs.core.imul(z,z);
n = G__51003;
y = G__51004;
z = G__51005;
continue;
...
var G__51006 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__51007 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__51006;
index__$1 = G__51007;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__50906 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__50906) : instaparse.auto_flatten_seq.true_count.call(null,G__50906));
})() - (1)))){
...
var G__51011 = v;
var G__51012 = cljs.core.pop(index);
v = G__51011;
index = G__51012;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__51021 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__51022 = cljs.core.next(coll__$1);
unmixed_hash = G__51021;
coll__$1 = G__51022;
continue;
} else {
return unmixed_hash;
...
var G__51023 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__51024 = cljs.core.next(v);
acc = G__51023;
v = G__51024;
continue;
} else {
var G__51025 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__51026 = cljs.core.next(v);
acc = G__51025;
v = G__51026;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_51027 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_51027(self);
}
});
