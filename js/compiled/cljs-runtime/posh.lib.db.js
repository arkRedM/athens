...
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40031__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40031__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40031__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40031__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__4126__auto__ = db;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
var fexpr__40033 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__40033.cljs$core$IFn$_invoke$arity$1 ? fexpr__40033.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__40033.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__40035 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__40035.cljs$core$IFn$_invoke$arity$2 ? fexpr__40035.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__40035.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__40036 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__40036.cljs$core$IFn$_invoke$arity$2 ? fexpr__40036.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__40036.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__40037 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__40037.cljs$core$IFn$_invoke$arity$2 ? fexpr__40037.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__40037.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__40039 = db__$4;
var G__40040 = (((filter instanceof cljs.core.Symbol))?null:filter);
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__40043,poshdb){
...
var posh_tree = map__40044__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40044__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40044__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__40047 = (function (){var G__40049 = posh_tree;
var G__40050 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__40049,G__40050) : posh.lib.db.poshdb__GT_db.call(null,G__40049,G__40050));
})();
var G__40048 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__40046 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__40046.cljs$core$IFn$_invoke$arity$2 ? fexpr__40046.cljs$core$IFn$_invoke$arity$2(G__40047,G__40048) : fexpr__40046.call(null,G__40047,G__40048));
}
});
