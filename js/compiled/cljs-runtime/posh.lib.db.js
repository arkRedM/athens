...
var G__40050 = cljs.core.cons(pdb,path);
var G__40051 = posh.lib.db.get_parent_db(pdb);
path = G__40050;
pdb = G__40051;
continue;
} else {
...
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__40030 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__40030.cljs$core$IFn$_invoke$arity$2 ? fexpr__40030.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__40030.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__40032 = db__$4;
var G__40033 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__40031 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__40031.cljs$core$IFn$_invoke$arity$2 ? fexpr__40031.cljs$core$IFn$_invoke$arity$2(G__40032,G__40033) : fexpr__40031.call(null,G__40032,G__40033));
})():db__$4);
return db__$5;
}));
...
var G__40039 = (function (){var G__40042 = posh_tree;
var G__40043 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__40042,G__40043) : posh.lib.db.poshdb__GT_db.call(null,G__40042,G__40043));
})();
