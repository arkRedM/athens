...
var fexpr__40028 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__40028.cljs$core$IFn$_invoke$arity$1 ? fexpr__40028.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__40028.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__40029 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__40029.cljs$core$IFn$_invoke$arity$2 ? fexpr__40029.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__40029.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__40030 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__40030.cljs$core$IFn$_invoke$arity$2 ? fexpr__40030.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__40030.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__40031 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__40031.cljs$core$IFn$_invoke$arity$2 ? fexpr__40031.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__40031.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__40033 = db__$4;
var G__40034 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__40032 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__40032.cljs$core$IFn$_invoke$arity$2 ? fexpr__40032.cljs$core$IFn$_invoke$arity$2(G__40033,G__40034) : fexpr__40032.call(null,G__40033,G__40034));
})():db__$4);
return db__$5;
}));
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__40039,poshdb){
...
var posh_tree = map__40040__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40040__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40040__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
