...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__64410,style_created_handler){
...
var style = map__64411__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64411__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64411__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__64415_64496 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__64415_64496) : style_created_handler.call(null,G__64415_64496));

var seq__64417 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__64418 = null;
var count__64419 = (0);
var i__64420 = (0);
while(true){
if((i__64420 < count__64419)){
var sub_style = chunk__64418.cljs$core$IIndexed$_nth$arity$2(null,i__64420);
var G__64429_64497 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__64430_64498 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__64429_64497,G__64430_64498) : stylefy.impl.styles.create_style_BANG_.call(null,G__64429_64497,G__64430_64498));


var G__64499 = seq__64417;
var G__64500 = chunk__64418;
var G__64501 = count__64419;
var G__64502 = (i__64420 + (1));
seq__64417 = G__64499;
chunk__64418 = G__64500;
count__64419 = G__64501;
i__64420 = G__64502;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__64417);
if(temp__5735__auto__){
var seq__64417__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__64417__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__64417__$1);
var G__64503 = cljs.core.chunk_rest(seq__64417__$1);
var G__64504 = c__4556__auto__;
var G__64505 = cljs.core.count(c__4556__auto__);
var G__64506 = (0);
seq__64417 = G__64503;
chunk__64418 = G__64504;
count__64419 = G__64505;
i__64420 = G__64506;
continue;
} else {
var sub_style = cljs.core.first(seq__64417__$1);
var G__64431_64507 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__64432_64508 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__64431_64507,G__64432_64508) : stylefy.impl.styles.create_style_BANG_.call(null,G__64431_64507,G__64432_64508));


var G__64509 = cljs.core.next(seq__64417__$1);
var G__64510 = null;
var G__64511 = (0);
var G__64512 = (0);
seq__64417 = G__64509;
chunk__64418 = G__64510;
count__64419 = G__64511;
i__64420 = G__64512;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__64437_SHARP_){
return ((typeof p1__64437_SHARP_ === 'string') || ((p1__64437_SHARP_ instanceof cljs.core.Keyword)) || ((p1__64437_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__64437#] (or (string? p1__64437#) (keyword? p1__64437#) (nil? p1__64437#))) class)))"].join('')));
}
});
/**
...
var len__4736__auto___64528 = arguments.length;
var i__4737__auto___64529 = (0);
while(true){
if((i__4737__auto___64529 < len__4736__auto___64528)){
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__64472_SHARP_,p2__64473_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__64472_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__64473_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq64474){
var G__64475 = cljs.core.first(seq64474);
var seq64474__$1 = cljs.core.next(seq64474);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64475,seq64474__$1);
}));
...
var styles_64538__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__64486_64539 = cljs.core.seq(styles_64538__$1);
var chunk__64487_64540 = null;
var count__64488_64541 = (0);
var i__64489_64542 = (0);
while(true){
if((i__64489_64542 < count__64488_64541)){
var style_64544 = chunk__64487_64540.cljs$core$IIndexed$_nth$arity$2(null,i__64489_64542);
stylefy.impl.styles.use_style_BANG_(style_64544,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___64545 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_64544));
if(cljs.core.truth_(temp__5735__auto___64545)){
var sub_styles_64546 = temp__5735__auto___64545;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_64546,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__64548 = seq__64486_64539;
var G__64549 = chunk__64487_64540;
var G__64550 = count__64488_64541;
var G__64551 = (i__64489_64542 + (1));
seq__64486_64539 = G__64548;
chunk__64487_64540 = G__64549;
count__64488_64541 = G__64550;
i__64489_64542 = G__64551;
continue;
} else {
var temp__5735__auto___64553 = cljs.core.seq(seq__64486_64539);
if(temp__5735__auto___64553){
var seq__64486_64554__$1 = temp__5735__auto___64553;
if(cljs.core.chunked_seq_QMARK_(seq__64486_64554__$1)){
var c__4556__auto___64555 = cljs.core.chunk_first(seq__64486_64554__$1);
var G__64557 = cljs.core.chunk_rest(seq__64486_64554__$1);
var G__64558 = c__4556__auto___64555;
var G__64559 = cljs.core.count(c__4556__auto___64555);
var G__64560 = (0);
seq__64486_64539 = G__64557;
chunk__64487_64540 = G__64558;
count__64488_64541 = G__64559;
i__64489_64542 = G__64560;
continue;
} else {
var style_64561 = cljs.core.first(seq__64486_64554__$1);
stylefy.impl.styles.use_style_BANG_(style_64561,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___64563__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_64561));
if(cljs.core.truth_(temp__5735__auto___64563__$1)){
var sub_styles_64564 = temp__5735__auto___64563__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_64564,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__64566 = cljs.core.next(seq__64486_64554__$1);
var G__64567 = null;
var G__64568 = (0);
var G__64569 = (0);
seq__64486_64539 = G__64566;
chunk__64487_64540 = G__64567;
count__64488_64541 = G__64568;
i__64489_64542 = G__64569;
continue;
}
} else {
}
