...
var G__51169 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4529__auto__ = (function instaparse$reduction$iter__51172(s__51173){
...
var vec__51176 = cljs.core._nth(c__4527__auto__,i__51174);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51176,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51176,(1),null);
cljs.core.chunk_append(b__51175,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__51184 = (i__51174 + (1));
i__51174 = G__51184;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__51175),instaparse$reduction$iter__51172(cljs.core.chunk_rest(s__51173__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__51175),null);
}
} else {
var vec__51179 = cljs.core.first(s__51173__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51179,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51179,(1),null);
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__51172(cljs.core.rest(s__51173__$2)));
}
} else {
return null;
}
