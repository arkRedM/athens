...
var with_let65867 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let65867","with-let65867",1691991408));
var temp__5739__auto___65869 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5739__auto___65869 == null)){
} else {
var c__26835__auto___65870 = temp__5739__auto___65869;
if((with_let65867.generation === c__26835__auto___65870.ratomGeneration)){
...
(with_let65867.generation = c__26835__auto___65870.ratomGeneration);
}


var init65868 = (with_let65867.length === (0));
var embed_id = ((init65868)?(with_let65867[(0)] = cljs.core.random_uuid()):(with_let65867[(0)]));
